...
class _AdminProductController extends __AppController
{
    ...
    protected function checkConstraint($model, &$errors, $columns2check) {
       ...
       if (in_array('LIST_PRICE', $columns2check) && !empty($model->LIST_PRICE) && !is_numeric($model->LIST_PRICE)) {
           $errors['list-price'] = sprintf(_t('L_VALIDATION_NUMBER'), _t('List price'));
           return false;
       }
    ...
    protected function _view($id, $details = null, $templatecode = 'view.adminproduct.tpl') {
    ...
    protected function _edit($id, $details = null, $templatecode = 'edit.adminproduct.tpl', $restoredraft = true) {
        $filtercolumns = $this->getCustomFilterColumns('adminproduct');
    ...
    protected function _import($templatecode = 'import.adminproduct.tpl') {
