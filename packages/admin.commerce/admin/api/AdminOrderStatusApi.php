...
class AdminOrderStatusApi extends AdminOrderStatusController
{
    var $module = 'adminorderstatus';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('adminorderstatus', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('adminorderstatus', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('adminorderstatus', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('adminorderstatus', 'view');
