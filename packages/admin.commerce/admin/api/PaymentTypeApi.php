...
class PaymentTypeApi extends PaymentTypeController
{
    var $module = 'paymenttype';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('paymenttype', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('paymenttype', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('paymenttype', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('paymenttype', 'view');
