...
class AdminProductApi extends AdminProductController
{
    var $module = 'adminproduct';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('adminproduct', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('adminproduct', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('adminproduct', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('adminproduct', 'view');
