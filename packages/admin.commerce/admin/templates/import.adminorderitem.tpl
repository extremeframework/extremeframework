...
<{php}>
	$template->assign('guidelines', sprintf(_t('L_GUIDELINES_IMPORT'), strtolower(Admin Order Item), APPLICATION_URL.'/adminorderitem/export', strtolower(Admin Order Item)));
<{/php}>
