...
INSERT IGNORE INTO `ADMIN_SEQUENCE` (`REFID`, `MODULE`, `SEQUENCE_FORMAT`, `CURRENT_VALUE`, `SEQUENCE_STEP`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES ('ADS0000000039', 'menu', 'MNUxxxxxxxxxx', 'MNU0000000011', '1', '1', '', '0', '', '1258e8d2-1baa-11e5-a175-cc52af77857f');
