...
<{php}>
	$template->assign('guidelines', sprintf(_t('L_GUIDELINES_IMPORT'), strtolower(Post Category), APPLICATION_URL.'/postcategory/export', strtolower(Post Category)));
<{/php}>

<{$guidelines}>

<form action="<{$smarty.const.APPLICATION_URL}>/postcategory/import" class="form-import scope-main" method="post" enctype="multipart/form-data">
