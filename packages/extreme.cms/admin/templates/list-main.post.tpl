...
<table class="item_list" id="postlist" data-module="post">
	...
	<tfoot>
            	...
            	<tr class="additem">
            	    <td colspan="2"></td>
            		<td colspan="<{$colcount}>">
                        <span style="cursor:pointer;text-decoration:underline;color:blue" class="post-rowedit-add"><{_t('Add item')}></span>
                	    <span class="post-rowedit-buttons" style="display:none">
                    	    <div class="rowedit-save post-rowedit-save btn btn-success"><{_t('Save')}></div>
                    	    <a class="rowedit-cancel post-rowedit-cancel button-cancel"><{_t('Cancel')}></a>
                        </span>
