...
<{php}>
	$template->assign('guidelines', sprintf(_t('L_GUIDELINES_IMPORT'), strtolower(Page Section), APPLICATION_URL.'/pagesection/export', strtolower(Page Section)));
<{/php}>

<{$guidelines}>

<form action="<{$smarty.const.APPLICATION_URL}>/pagesection/import" class="form-import scope-main" method="post" enctype="multipart/form-data">
