<div class="view-main">
    <{plugin key="pagelinktype_view_top" args=$details}>
        ...
        <{if !isset($columns2hide) || !in_array('NAME', $columns2hide) }>
    		<td class="form-field form-field-label column-name">
	            		        <label class="attribute-name"><{label key="L_PAGE_LINK_TYPE_NAME"}></label>
            </td>
    ...
    <{plugin key="pagelinktype_view_bottom" args=$details}>

    <script type="text/javascript">
        ///////////////////////////////////////////////////////////////////////////////
        // VISIBILITY REFLECTION
        pagelinktypeview_get_visibility_settings = function (model) {
            var settings = {};
        ...
        pagelinktypeview_apply_visibility_settings = function (settings) {
            $.each(settings, function(key, value) {
                pagelinktypeview_apply_block_visibility(key, value);
            });
        }

        pagelinktypeview_apply_block_visibility = function (key, value) {
        ...
        pagelinktypeview_update_visibility_settings = function () {
            var settings = pagelinktypeview_get_visibility_settings();

            pagelinktypeview_apply_visibility_settings(settings);
        }

        $(function() {
            pagelinktypeview_update_visibility_settings();
        });
...
//                        type: "post",
//                        dataType: "json",
//                        url: "<{$smarty.const.APPLICATION_URL}>/pagelinktype/fieldSave",
//                        data: td.find(':input').serialize() + "&pagelinktype_formdata_UUID=<{$details->UUID}>"
//                    }).done(function(data) {
//                        if (data.success) {
//                            if (input.is("select")) {
