...
<tr class="embedded-view <{$type}>-embedded-view page-<{$type}>-embedded-view-<{$details->UUID}>" data-id="<{$details->UUID}>">
    <{if $smarty.request.source == 'list'}>
    	<td colspan="<{$smarty.request.colcount + 1}>">
            <div class="page-view view_details">
                <div class="section">
    	...
    	<td style="vertical-align: top;">
    	    <{if isset($smarty.session.acl.page.edit) && WorkflowHelper::isEditable($details->WFID) && !$readonly}>
