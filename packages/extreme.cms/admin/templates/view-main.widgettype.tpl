<div class="view-main">
    <{plugin key="widgettype_view_top" args=$details}>
        ...
        <{if !isset($columns2hide) || !in_array('NAME', $columns2hide) }>
    		<td class="form-field form-field-label column-name">
	            		        <label class="attribute-name"><{label key="L_WIDGET_TYPE_NAME"}></label>
            </td>
    ...
    <{plugin key="widgettype_view_bottom" args=$details}>

    <script type="text/javascript">
        ///////////////////////////////////////////////////////////////////////////////
        // VISIBILITY REFLECTION
        widgettypeview_get_visibility_settings = function (model) {
            var settings = {};
        ...
        widgettypeview_apply_visibility_settings = function (settings) {
            $.each(settings, function(key, value) {
                widgettypeview_apply_block_visibility(key, value);
            });
        }

        widgettypeview_apply_block_visibility = function (key, value) {
        ...
        widgettypeview_update_visibility_settings = function () {
            var settings = widgettypeview_get_visibility_settings();

            widgettypeview_apply_visibility_settings(settings);
        }

        $(function() {
            widgettypeview_update_visibility_settings();
        });
...
//                        type: "post",
//                        dataType: "json",
//                        url: "<{$smarty.const.APPLICATION_URL}>/widgettype/fieldSave",
//                        data: td.find(':input').serialize() + "&widgettype_formdata_UUID=<{$details->UUID}>"
//                    }).done(function(data) {
//                        if (data.success) {
//                            if (input.is("select")) {
