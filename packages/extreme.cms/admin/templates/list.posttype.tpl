...
<{assign var='title' value=_t('L_POST_TYPE')}>
...
<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="posttypequicksearch" class="form-quicksearch scope-list" action="<{$smarty.const.APPLICATION_URL}>/posttype/search" method="post" enctype="multipart/form-data">
            <input type="text" name="posttype_searchdata___QUICKSEARCH__" value="<{if isset($searchdata.__QUICKSEARCH__)}><{$searchdata.__QUICKSEARCH__}><{/if}>" size="25" placeholder="<{_t('L_SEARCH')}>" />
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main" href="<{$smarty.const.APPLICATION_URL}>/posttype/new/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{_t('L_NEW')}> <{_t('L_POST_TYPE')|strtolower}>"/><{_t('L_NEW')}> <{_t('L_POST_TYPE')|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
        	    ...
        	    <{/if}>
                                            ...
                                            <div class="btn button-general">
                            <a href="#" onclick="posttype_delete()"><span class="button-face"><{_t('L_DELETE')}></span></a>
                        </div>
                                            <{/if}>
                                                                                <{if isset($smarty.session.acl.posttype.import)}>
                                            <div class="btn button-general">
                            <a class="button-import scope-main" href="<{$smarty.const.APPLICATION_URL}>/posttype/import/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-import.png" alt="<{_t('L_IMPORT')}>" /><{_t('L_IMPORT')}></span></a>
                        </div>
                                            <{/if}>
                                                                                <{if isset($smarty.session.acl.posttype.export)}>
                                            <div class="btn button-general">
                            <a class="button-export" href="<{$smarty.const.APPLICATION_URL}>/posttype/export/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-export.png" alt="<{_t('L_EXPORT')}>" /><{_t('L_EXPORT')}></span></a>
                        </div>
                                            <{/if}>
...
<!-- Relations -->
    ...
    <div id="posttypecopyrelations" style="display:none" title="<{_t('L_COPY')}> <{_t('L_POST_TYPE')|strtolower}>">
        <p><{$copyguidelines}></p>
        <ul>
    ...
    <div id="posttypeapproverelations" style="display:none" title="<{_t('L_APPROVE')}> <{_t('L_POST_TYPE')|strtolower}>">
    ...
    <div id="posttypedeleterelations" style="display:none" title="<{_t('L_DELETE')}> <{_t('L_POST_TYPE')|strtolower}>">
...
<{if $pagination || $total > 10}>
	...
	<div style="float:left">
		<span class="posttype-list-count list-count"><{$total}></span> <{_t('L_RECORDS')}>
	</div>
	<div style="clear:both"></div>
<{/if}>
