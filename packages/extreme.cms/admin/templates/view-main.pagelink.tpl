<div class="view-main">
    <{plugin key="pagelink_view_top" args=$details}>
        ...
        <{if !isset($columns2hide) || !in_array('TITLE', $columns2hide) }>
    		<td class="form-field form-field-label column-title">
	            		        <label class="attribute-name"><{_t('Page link title')}></label>
            </td>
    ...
    <{/if}>
            ...
            <{html_ref_select multilingual="0" autocomplete="1" ajax="0" method="" id="input-id-page" class="input-id-page" name="`$prefix`pagelink_formdata_ID_PAGE" value=$details->ID_PAGE text=$details->reftext_ID_PAGE datasource="PAGE" datasourcename="Page" valuecol="ID" textcol="NAME" sortcol="NAME"}>
    ...
    <{/if}>
            ...
            <{if Framework::hasModule('Page')}>
            <{html_ref_select multilingual="0" autocomplete="1" ajax="0" method="" id="input-link-id-page" class="input-link-id-page" name="`$prefix`pagelink_formdata_LINK_ID_PAGE" value=$details->LINK_ID_PAGE text=$details->reftext_LINK_ID_PAGE datasource="PAGE" datasourcename="Page" valuecol="ID" textcol="NAME" sortcol="NAME"}>
	...
	<{/if}>
        ...
        <{if !isset($columns2hide) || !in_array('ID_PAGE_LINK_TYPE', $columns2hide) }>
    		<td class="form-field form-field-label column-id-page-link-type">
	                    		                    		        <label class="attribute-name"><{_t('Page link type')}></label>
            </td>
    ...
    <{/if}>
            ...
            <{html_ref_select multilingual="1" autocomplete="1" ajax="0" method="" id="input-id-page-link-type" class="input-id-page-link-type" name="`$prefix`pagelink_formdata_ID_PAGE_LINK_TYPE" value=$details->ID_PAGE_LINK_TYPE text=$details->reftext_ID_PAGE_LINK_TYPE datasource="PAGE_LINK_TYPE" datasourcename="PageLinkType" valuecol="CODE" textcol="NAME" sortcol="NAME"}>
