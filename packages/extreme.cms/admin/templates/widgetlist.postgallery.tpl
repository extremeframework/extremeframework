...
<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="postgalleryquicksearch" class="form-quicksearch scope-main" action="<{$smarty.const.APPLICATION_URL}>/postgallery/search" method="post" enctype="multipart/form-data">
...
<form name="postgallerylist" id="postgallerylistform" class="form-list scope-main" action="<{$smarty.const.APPLICATION_URL}>/postgallery/" method="post">
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main" href="<{$smarty.const.APPLICATION_URL}>/postgallery/new/<{if isset($preset) && isset($presetvalue)}>preset/<{$preset}>/presetvalue/<{$presetvalue}><{/if}><{if isset($presetstring)}>?<{$presetstring}><{/if}>"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{$smarty.const.L_NEW}> <{$smarty.const.L_POST_GALLERY|strtolower}>"/><{label key="L_NEW"}> <{$smarty.const.L_POST_GALLERY|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
...
<{if $pagination || $total > 10}>
	...
	<div style="clear:both"></div>
            ...
            <script type="text/javascript">
            $(function() {
            	bind_hotkey('#postgallerylistform', 'left', '.pagination-prev');
            	bind_hotkey('#postgallerylistform', 'right', '.pagination-next');
            });
        </script>
    <{else}>
	<br>
