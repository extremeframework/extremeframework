    ...
    <div class="view-buttons">
    	<{if $details->UUID}>
    	    ...
    	    <{/foreach}>
    	            ...
    	            <{if $admin_view_actions || $admin_view_options || isset($smarty.session.acl.page.customfields)}>
        	    <div class="button-general dropdown">
        	        ...
        	        <ul class="dropdown-menu pull-right">
                        ...
                        <{/foreach}>
                        <{if isset($smarty.session.acl.page.customfields)}>
                            <li><a class="scope-main" href="<{$smarty.const.APPLICATION_URL}>/customfield/manage/page"><{_t('Manage custom fields')}></a></li>
                        <{/if}>
                    </ul>
        	    </div>
            <{/if}>
            <div class="button-general">
                <a class="button-close scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/page/close/"><span class="button-face"><{_t('Close')}></span></a>
            </div>
