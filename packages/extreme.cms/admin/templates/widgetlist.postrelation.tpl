...
<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="postrelationquicksearch" class="form-quicksearch scope-main" action="<{$smarty.const.APPLICATION_URL}>/postrelation/search" method="post" enctype="multipart/form-data">
...
<form name="postrelationlist" id="postrelationlistform" class="form-list scope-main" action="<{$smarty.const.APPLICATION_URL}>/postrelation/" method="post">
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main" href="<{$smarty.const.APPLICATION_URL}>/postrelation/new/<{if isset($preset) && isset($presetvalue)}>preset/<{$preset}>/presetvalue/<{$presetvalue}><{/if}><{if isset($presetstring)}>?<{$presetstring}><{/if}>"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{$smarty.const.L_NEW}> <{$smarty.const.L_POST_RELATION|strtolower}>"/><{label key="L_NEW"}> <{$smarty.const.L_POST_RELATION|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
...
<{if $pagination || $total > 10}>
	...
	<div style="clear:both"></div>
            ...
            <script type="text/javascript">
            $(function() {
            	bind_hotkey('#postrelationlistform', 'left', '.pagination-prev');
            	bind_hotkey('#postrelationlistform', 'right', '.pagination-next');
            });
        </script>
    <{else}>
	<br>
