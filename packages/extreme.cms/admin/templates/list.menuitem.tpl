...
<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="menuitemquicksearch" class="form-quicksearch scope-list" action="<{$smarty.const.APPLICATION_URL}>/menuitem/search" method="get">
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/menuitem/new/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{_t('L_NEW', true)}> <{_t('L_MENU_ITEM', true)|strtolower}>"/><{_t('L_NEW')}> <{_t('L_MENU_ITEM')|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
        	    ...
        	    <{/if}>
                            ...
                            <a href="#" onclick="menuitem_delete()"><span class="button-face"><{_t('L_DELETE')}></span></a>
                                            ...
                                            <div class="btn button-general">
                            <a class="button-import scope-main" href="<{$smarty.const.APPLICATION_URL}>/menuitem/import/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-import.png" alt="<{_t('L_IMPORT', true)}>" /><{_t('L_IMPORT')}></span></a>
                        </div>
                                            <{/if}>
                                                                                <{if isset($smarty.session.acl.menuitem.export)}>
                                            <div class="btn button-general">
                            <a class="button-export" href="<{$smarty.const.APPLICATION_URL}>/menuitem/export/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-export.png" alt="<{_t('L_EXPORT', true)}>" /><{_t('L_EXPORT')}></span></a>
                        </div>
                                            <{/if}>
...
<!-- Relations -->
    <{php}>
    	$template->assign('copyguidelines',  sprintf(_t('L_GUIDELINES_COPY_RELS'), strtolower(_t('L_MENU_ITEM'))));
    	$template->assign('approveguidelines', sprintf(_t('L_GUIDELINES_APPROVE_RELS'), strtolower(_t('L_MENU_ITEM'))));
    	$template->assign('deleteguidelines', sprintf(_t('L_GUIDELINES_DELETE_RELS'), strtolower(_t('L_MENU_ITEM')), strtolower(_t('L_MENU_ITEM'))));
    <{/php}>

    <div id="menuitemcopyrelations" style="display:none" title="<{_t('L_COPY', true)}> <{_t('L_MENU_ITEM', true)|strtolower}>">
        <p><{$copyguidelines}></p>
        <ul>
    ...
    <div id="menuitemapproverelations" style="display:none" title="<{_t('L_APPROVE', true)}> <{_t('L_MENU_ITEM', true)|strtolower}>">
    ...
    <div id="menuitemdeleterelations" style="display:none" title="<{_t('L_DELETE', true)}> <{_t('L_MENU_ITEM', true)|strtolower}>">
