...
<{php}>
	$template->assign('guidelines', sprintf(_t('L_GUIDELINES_IMPORT'), strtolower(Post), APPLICATION_URL.'/post/export', strtolower(Post)));
<{/php}>
...
<div class="form-row">
    <label><{_t('L_CSV_FILE_CONTAINS_DATA_ABOUT')}> <{_t('Post')|strtolower}></label>
