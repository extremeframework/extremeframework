...
<{php}>
	$template->assign('guidelines', sprintf(_t('L_GUIDELINES_IMPORT'), strtolower(Menu), APPLICATION_URL.'/menu/export', strtolower(Menu)));
<{/php}>
...
<div class="form-row">
    <label><{_t('L_CSV_FILE_CONTAINS_DATA_ABOUT')}> <{_t('Menu')|strtolower}></label>
