...
<div class="edit_details">
    ...
    <div class="edit-buttons edit-buttons-top hidden-print">
        ...
        <{/foreach}>
        <a class="button-cancel scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/menu/cancel/?return=<{ContextStack::getCurrentContext()}>"><span class="button-face"><{_t('Cancel')}></span></a>
