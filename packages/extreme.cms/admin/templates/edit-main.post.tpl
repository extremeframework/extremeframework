...
<tr class="form-row form-row-id-post-type form-row-mandatory">
        ...
        <{else}>
            ...
            <{html_ref_select multilingual="1" autocomplete="1" ajax="0" method="" id="input-id-post-type" class="input-id-post-type" name="`$prefix`post_formdata_ID_POST_TYPE" value=$details->ID_POST_TYPE text=$details->reftext_ID_POST_TYPE datasource="POST_TYPE" datasourcename="PostType" valuecol="CODE" textcol="NAME" sortcol="NAME" groupcol="" blankitem=""}>
...
<tr class="form-row form-row-id-post-category">
        ...
        <{else}>
            ...
            <{html_ref_select multilingual="1" autocomplete="1" ajax="0" method="" id="input-id-post-category" class="input-id-post-category" name="`$prefix`post_formdata_ID_POST_CATEGORY" value=$details->ID_POST_CATEGORY text=$details->reftext_ID_POST_CATEGORY datasource="POST_CATEGORY" datasourcename="PostCategory" valuecol="ID" textcol="NAME" sortcol="NAME" groupcol="" blankitem=""}>
...
<tr class="form-row form-row-meta-description">
    ...
    <textarea class="input-meta-description " id="<{$prefix}>post_formdata_META_DESCRIPTION_<{$tmpid}>" name="<{$prefix}>post_formdata_META_DESCRIPTION" rows="5" ><{$details->META_DESCRIPTION}></textarea>
    	...
    	<{/if}>
    <{/if}>    </tr>                                                                                            
<tr class="form-row form-row-excerpt">
...
<tr class="form-row form-row-author">
    ...
    <input class="input-author input-type-text" type="text" name="<{$prefix}>post_formdata_AUTHOR" value="<{$details->AUTHOR|escape}>"  />
    	...
    	<{/if}>
    <{/if}>    </tr>                                                                                            
<tr class="form-row form-row-external-link">
...
<tr class="form-row form-row-id-template form-row-mandatory">
        ...
        <{else}>
            ...
            <{html_ref_select multilingual="0" autocomplete="1" ajax="0" method="" id="input-id-template" class="input-id-template" name="`$prefix`post_formdata_ID_TEMPLATE" value=$details->ID_TEMPLATE text=$details->reftext_ID_TEMPLATE datasource="TEMPLATE" datasourcename="Template" valuecol="CODE" textcol="NAME" sortcol="NAME" groupcol="" blankitem=""}>
...
<tr class="form-row form-row-is-featured">
