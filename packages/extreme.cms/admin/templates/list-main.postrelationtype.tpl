...
<table class="item_list" id="postrelationtypelist" data-module="postrelationtype">
	...
	<tfoot>
            	...
            	<tr class="additem">
            	    <td colspan="2"></td>
            		<td colspan="<{$colcount}>">
                        <span style="cursor:pointer;text-decoration:underline;color:blue" class="postrelationtype-rowedit-add"><{_t('Add item')}></span>
                	    <span class="postrelationtype-rowedit-buttons" style="display:none">
                    	    <div class="rowedit-save postrelationtype-rowedit-save btn btn-success"><{_t('Save')}></div>
                    	    <a class="rowedit-cancel postrelationtype-rowedit-cancel button-cancel"><{_t('Cancel')}></a>
                        </span>
