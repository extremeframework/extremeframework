<div class="modal-header">
    ...
    <h3><{label key="L_QUICK_CREATE" format="ucwords"}> <{$smarty.const.L_POST_TYPE|ucwords}></h3>
</div>
...
<div id="posttype-edit" class="edit_details">
    ...
    <{if isset($messages.posttype) }>
        <ul class="message">
            <{foreach from=$messages.posttype key=field item=message}>
        ...
        <{else}>
    		<td class="form-row form-row-name form-row-mandatory">
                <div class="form-field form-field-label">
        		    <label><{label key="L_POST_TYPE_NAME"}><span class="mandatory">*</span></label>
                </div>
            </td>
