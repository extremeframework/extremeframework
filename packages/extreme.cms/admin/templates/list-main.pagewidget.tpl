...
<table class="item_list" id="pagewidgetlist" data-module="pagewidget">
	...
	<tfoot>
            	...
            	<tr class="additem">
            	    <td colspan="2"></td>
            		<td colspan="<{$colcount}>">
                        <span style="cursor:pointer;text-decoration:underline;color:blue" class="pagewidget-rowedit-add"><{_t('L_ADD_ITEM')}></span>
                	    <span class="pagewidget-rowedit-buttons" style="display:none">
                    	    <div class="rowedit-save pagewidget-rowedit-save btn btn-success"><{_t('L_SAVE')}></div>
                    	    <a class="rowedit-cancel pagewidget-rowedit-cancel button-cancel"><{_t('L_CANCEL')}></a>
                        </span>
