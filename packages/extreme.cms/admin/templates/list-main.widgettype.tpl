...
<table class="item_list" id="widgettypelist" data-module="widgettype">
	...
	<tfoot>
            	...
            	<tr class="additem">
            	    <td colspan="2"></td>
            		<td colspan="<{$colcount}>">
                        <span style="cursor:pointer;text-decoration:underline;color:blue" class="widgettype-rowedit-add"><{_t('L_ADD_ITEM')}></span>
                	    <span class="widgettype-rowedit-buttons" style="display:none">
                    	    <div class="rowedit-save widgettype-rowedit-save btn btn-success"><{_t('L_SAVE')}></div>
                    	    <a class="rowedit-cancel widgettype-rowedit-cancel button-cancel"><{_t('L_CANCEL')}></a>
                        </span>
