...
<table class="item_list" id="widgettypelist" data-module="widgettype">
        ...
        <{assign var='colcount' value=1}>
    	        ...
    	        <{if !isset($excludedcolumns['NAME']) && ((isset($aclviewablecolumns['NAME']) && $aclviewablecolumns['NAME']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['NAME']) || $aclviewablecolumns['NAME']))) }>
    	            <th class="column-name">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/widgettype/sort/name"><{_t('Widget type name')}></a>
            ...
            <{/if}>
    	        ...
    	        <{if !isset($excludedcolumns['CODE']) && ((isset($aclviewablecolumns['CODE']) && $aclviewablecolumns['CODE']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['CODE']) || $aclviewablecolumns['CODE']))) }>
    	            <th class="column-code">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/widgettype/sort/code"><{_t('Code')}></a>
	...
	<tr class="top-holder" style="display:none">
	    <td colspan="<{$colcount+2}>" style="text-align:center;">
	    	<div class="selectall">All <{$rows|@count}> <{_t('Widget Types')|strtolower}> on this page are selected. <a onclick="widgettype_selectall()">Select all <{$total}> <{_t('Widget Types')|strtolower}> in the list</a></div>
	    	<div class="clearselection">All <{$total}> <{_t('Widget Types')|strtolower}> in the list are selected. <a onclick="widgettype_clearselection()">Clear selection</a></div>
		</td>
	</tr>
	<{/if}>
