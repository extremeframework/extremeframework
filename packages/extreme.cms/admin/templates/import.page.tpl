...
<{php}>
	$template->assign('guidelines', sprintf(_t('L_GUIDELINES_IMPORT'), strtolower(Page), APPLICATION_URL.'/page/export', strtolower(Page)));
<{/php}>
...
<div class="form-row">
    <label><{_t('L_CSV_FILE_CONTAINS_DATA_ABOUT')}> <{_t('Page')|strtolower}></label>
