...
<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="postsectionquicksearch" class="form-quicksearch scope-main" action="<{$smarty.const.APPLICATION_URL}>/postsection/search" method="post" enctype="multipart/form-data">
