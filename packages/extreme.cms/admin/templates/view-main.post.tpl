<div class="view-main">
    <{plugin key="post_view_top" args=$details}>
        ...
        <{if !isset($columns2hide) || !in_array('TITLE', $columns2hide) }>
    		<td class="form-field form-field-label column-title">
	            		        <label class="attribute-name"><{_t('Post title')}></label>
            </td>
	...
	<{/if}>
        ...
        <{if !isset($columns2hide) || !in_array('ID_POST_TYPE', $columns2hide) }>
    		<td class="form-field form-field-label column-id-post-type">
	                    		                    		        <label class="attribute-name"><{_t('Post type')}></label>
            </td>
    ...
    <{if $details->reftext_ID_POST_TYPE}>
        <{if isset($smarty.session.acl.posttype.view)}>
            <a class="scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/posttype/view/<{$details->refuuid_ID_POST_TYPE}>"><{$details->reftext_ID_POST_TYPE|escape}></a>
        <{else}>
    ...
    <{/if}>
            ...
            <{html_ref_select multilingual="1" autocomplete="1" ajax="0" method="" id="input-id-post-type" class="input-id-post-type" name="`$prefix`post_formdata_ID_POST_TYPE" value=$details->ID_POST_TYPE text=$details->reftext_ID_POST_TYPE datasource="POST_TYPE" valuecol="CODE" textcol="NAME" sortcol=""}>
    ...
    <{/if}>
            ...
            <{html_ref_select multilingual="1" autocomplete="1" ajax="0" method="" id="input-id-post-category" class="input-id-post-category" name="`$prefix`post_formdata_ID_POST_CATEGORY" value=$details->ID_POST_CATEGORY text=$details->reftext_ID_POST_CATEGORY datasource="POST_CATEGORY" valuecol="ID" textcol="NAME" sortcol=""}>
	...
	<{/if}>
        ...
        <{if !isset($columns2hide) || !in_array('EXCERPT', $columns2hide) }>
    		<td class="form-field form-field-label column-excerpt">
	            		        <label class="attribute-name"><{_t('Excerpt')}></label>
            </td>
	...
	<{/if}>
        ...
        <{if !isset($columns2hide) || !in_array('EXTERNAL_LINK', $columns2hide) }>
    		<td class="form-field form-field-label column-external-link">
	            		        <label class="attribute-name"><{_t('External link')}></label>
            </td>
    ...
    <{/if}>
            ...
            <{html_ref_select multilingual="0" autocomplete="1" ajax="0" method="" id="input-id-template" class="input-id-template" name="`$prefix`post_formdata_ID_TEMPLATE" value=$details->ID_TEMPLATE text=$details->reftext_ID_TEMPLATE datasource="TEMPLATE" valuecol="CODE" textcol="NAME" sortcol=""}>
	...
	<{/if}>
        ...
        <{if !isset($columns2hide) || !in_array('IS_FEATURED', $columns2hide) }>
    		<td class="form-field form-field-label column-is-featured">
	            		        <label class="attribute-name"><{_t('Featured?')}></label>
            </td>
    ...
    <{if $details->IS_FEATURED}><{_t('Yes')}><{else}><{_t('No')}><{/if}>
                                </span>
                                <!--
                    		    <span class="edit-mode" style="display:none">
