<div class="modal-header">
    ...
    <h3><{label key="L_QUICK_CREATE" format="ucwords"}> <{$smarty.const.L_POST|ucwords}></h3>
</div>
        ...
        post_update_visibility_settings();
            ...
            <button class="btn btn-success" type="submit" onclick="$('#pageform').submit()">
                <strong><{label key="L_SAVE"}></strong>
                            ...
                            <a class="btn btn-full-form scope-main" href="<{$smarty.const.APPLICATION_URL}>/post/new">
