<div class="view-main">
    <{plugin key="widgetposition_view_top" args=$details}>
        ...
        <{if !isset($columns2hide) || !in_array('NAME', $columns2hide) }>
    		<td class="form-field form-field-label column-name">
	            		        <label class="attribute-name"><{label key="L_WIDGET_POSITION_NAME"}></label>
            </td>
    ...
    <{plugin key="widgetposition_view_bottom" args=$details}>

    <script type="text/javascript">
        ///////////////////////////////////////////////////////////////////////////////
        // VISIBILITY REFLECTION
        widgetpositionview_get_visibility_settings = function (model) {
            var settings = {};
        ...
        widgetpositionview_apply_visibility_settings = function (settings) {
            $.each(settings, function(key, value) {
                widgetpositionview_apply_block_visibility(key, value);
            });
        }

        widgetpositionview_apply_block_visibility = function (key, value) {
        ...
        widgetpositionview_update_visibility_settings = function () {
            var settings = widgetpositionview_get_visibility_settings();

            widgetpositionview_apply_visibility_settings(settings);
        }

        $(function() {
            widgetpositionview_update_visibility_settings();
        });
...
//                        type: "post",
//                        dataType: "json",
//                        url: "<{$smarty.const.APPLICATION_URL}>/widgetposition/fieldSave",
//                        data: td.find(':input').serialize() + "&widgetposition_formdata_UUID=<{$details->UUID}>"
//                    }).done(function(data) {
//                        if (data.success) {
//                            if (input.is("select")) {
