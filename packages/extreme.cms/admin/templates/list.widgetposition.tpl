...
<{assign var='title' value=_t('Widget Position')}>
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/widgetposition/new/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{_t('New', true)}> <{_t('Widget Position', true)|strtolower}>"/><{_t('New')}> <{_t('Widget Position')|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
        	    ...
        	    <{/if}>
                            ...
                            <a href="#" onclick="widgetposition_delete()"><span class="button-face"><{_t('Delete')}></span></a>
                                            ...
                                            <div class="btn button-general">
                            <a class="button-import scope-main" href="<{$smarty.const.APPLICATION_URL}>/widgetposition/import/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-import.png" alt="<{_t('Import', true)}>" /><{_t('Import')}></span></a>
                        </div>
                                            <{/if}>
                                                                                <{if isset($smarty.session.acl.widgetposition.export)}>
                                            <div class="btn button-general">
                            <a class="button-export" href="<{$smarty.const.APPLICATION_URL}>/widgetposition/export/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-export.png" alt="<{_t('Export', true)}>" /><{_t('Export')}></span></a>
                        </div>
                                            <{/if}>
...
<!-- Relations -->
    <{php}>
    	$template->assign('copyguidelines',  sprintf(_t('L_GUIDELINES_COPY_RELS', true), strtolower(_t('Widget Position', true))));
    	$template->assign('approveguidelines', sprintf(_t('L_GUIDELINES_APPROVE_RELS', true), strtolower(_t('Widget Position', true))));
    	$template->assign('deleteguidelines', sprintf(_t('L_GUIDELINES_DELETE_RELS', true), strtolower(_t('Widget Position', true)), strtolower(_t('Widget Position', true))));
    <{/php}>

    <div id="widgetpositioncopyrelations" style="display:none" title="<{_t('Copy', true)}> <{_t('Widget Position', true)|strtolower}>">
        <p><{$copyguidelines}></p>
        <ul>
    ...
    <div id="widgetpositionapproverelations" style="display:none" title="<{_t('Approve', true)}> <{_t('Widget Position', true)|strtolower}>">
    ...
    <div id="widgetpositiondeleterelations" style="display:none" title="<{_t('Delete', true)}> <{_t('Widget Position', true)|strtolower}>">
