...
<{assign var='title' value=_t('L_WIDGET_POSITION')}>
<{include file="top.tpl"}>

<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="widgetpositionquicksearch" class="form-quicksearch scope-list" action="<{$smarty.const.APPLICATION_URL}>/widgetposition/search" method="get">
            <input type="text" name="widgetposition_searchdata___QUICKSEARCH__" value="<{if isset($searchdata.__QUICKSEARCH__)}><{$searchdata.__QUICKSEARCH__}><{/if}>" size="25" placeholder="<{_t('L_SEARCH', true)}>" />
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/widgetposition/new/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{_t('L_NEW', true)}> <{_t('L_WIDGET_POSITION', true)|strtolower}>"/><{_t('L_NEW')}> <{_t('L_WIDGET_POSITION')|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
        	    ...
        	    <{/if}>
                            ...
                            <a href="#" onclick="widgetposition_delete()"><span class="button-face"><{_t('L_DELETE')}></span></a>
                                            ...
                                            <div class="btn button-general">
                            <a class="button-import scope-main" href="<{$smarty.const.APPLICATION_URL}>/widgetposition/import/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-import.png" alt="<{_t('L_IMPORT', true)}>" /><{_t('L_IMPORT')}></span></a>
                        </div>
                                            <{/if}>
                                                                                <{if isset($smarty.session.acl.widgetposition.export)}>
                                            <div class="btn button-general">
                            <a class="button-export" href="<{$smarty.const.APPLICATION_URL}>/widgetposition/export/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-export.png" alt="<{_t('L_EXPORT', true)}>" /><{_t('L_EXPORT')}></span></a>
                        </div>
                                            <{/if}>
...
<!-- Relations -->
    <{php}>
    	$template->assign('copyguidelines',  sprintf(_t('L_GUIDELINES_COPY_RELS'), strtolower(_t('L_WIDGET_POSITION'))));
    	$template->assign('approveguidelines', sprintf(_t('L_GUIDELINES_APPROVE_RELS'), strtolower(_t('L_WIDGET_POSITION'))));
    	$template->assign('deleteguidelines', sprintf(_t('L_GUIDELINES_DELETE_RELS'), strtolower(_t('L_WIDGET_POSITION')), strtolower(_t('L_WIDGET_POSITION'))));
    <{/php}>

    <div id="widgetpositioncopyrelations" style="display:none" title="<{_t('L_COPY', true)}> <{_t('L_WIDGET_POSITION', true)|strtolower}>">
        <p><{$copyguidelines}></p>
        <ul>
    ...
    <div id="widgetpositionapproverelations" style="display:none" title="<{_t('L_APPROVE', true)}> <{_t('L_WIDGET_POSITION', true)|strtolower}>">
    ...
    <div id="widgetpositiondeleterelations" style="display:none" title="<{_t('L_DELETE', true)}> <{_t('L_WIDGET_POSITION', true)|strtolower}>">
...
<{if $pagination || $total > 10}>
	...
	<div style="float:left">
		<span class="widgetposition-list-count list-count"><{$total}></span> <{_t('L_RECORDS')}>
	</div>
	<div style="clear:both"></div>
<{/if}>
