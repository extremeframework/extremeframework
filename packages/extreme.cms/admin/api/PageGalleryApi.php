...
class PageGalleryApi extends PageGalleryController
{
    var $module = 'pagegallery';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('pagegallery', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('pagegallery', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('pagegallery', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('pagegallery', 'view');
