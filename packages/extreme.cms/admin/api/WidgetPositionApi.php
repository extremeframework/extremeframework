...
class WidgetPositionApi extends WidgetPositionController
{
    var $module = 'widgetposition';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('widgetposition', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('widgetposition', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('widgetposition', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('widgetposition', 'view');
