...
class PostTypeApi extends PostTypeController
{
    var $module = 'posttype';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('posttype', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('posttype', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('posttype', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('posttype', 'view');
