...
class PageLinkTypeApi extends PageLinkTypeController
{
    var $module = 'pagelinktype';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('pagelinktype', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('pagelinktype', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('pagelinktype', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('pagelinktype', 'view');
