...
class MenuApi extends MenuController
{
    var $module = 'menu';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('menu', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('menu', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('menu', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('menu', 'view');
