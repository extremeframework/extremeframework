...
class PostCategoryApi extends PostCategoryController
{
    var $module = 'postcategory';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('postcategory', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('postcategory', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('postcategory', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('postcategory', 'view');
