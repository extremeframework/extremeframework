...
class PageSectionApi extends PageSectionController
{
    var $module = 'pagesection';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('pagesection', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('pagesection', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('pagesection', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('pagesection', 'view');
