...
class PageLinkApi extends PageLinkController
{
    var $module = 'pagelink';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('pagelink', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('pagelink', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('pagelink', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('pagelink', 'view');
