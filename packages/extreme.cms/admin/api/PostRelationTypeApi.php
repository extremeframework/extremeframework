...
class PostRelationTypeApi extends PostRelationTypeController
{
    var $module = 'postrelationtype';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('postrelationtype', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('postrelationtype', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('postrelationtype', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('postrelationtype', 'view');
