...
class PostApi extends PostController
{
    var $module = 'post';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('post', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('post', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('post', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('post', 'view');
