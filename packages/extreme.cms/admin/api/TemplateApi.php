...
class TemplateApi extends TemplateController
{
    var $module = 'template';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('template', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('template', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('template', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('template', 'view');
