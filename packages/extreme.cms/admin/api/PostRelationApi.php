...
class PostRelationApi extends PostRelationController
{
    var $module = 'postrelation';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('postrelation', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('postrelation', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('postrelation', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('postrelation', 'view');
