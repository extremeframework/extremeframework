...
class MenuItemApi extends MenuItemController
{
    var $module = 'menuitem';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('menuitem', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('menuitem', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('menuitem', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('menuitem', 'view');
