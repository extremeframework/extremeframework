...
class WidgetTypeApi extends WidgetTypeController
{
    var $module = 'widgettype';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('widgettype', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('widgettype', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('widgettype', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('widgettype', 'view');
