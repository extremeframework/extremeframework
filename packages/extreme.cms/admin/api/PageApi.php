...
class PageApi extends PageController
{
    var $module = 'page';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('page', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('page', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('page', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('page', 'view');
