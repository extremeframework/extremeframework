...
class PageWidgetApi extends PageWidgetController
{
    var $module = 'pagewidget';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('pagewidget', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('pagewidget', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('pagewidget', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('pagewidget', 'view');
