...
class _PostTypeController extends __AppController
{
    ...
    private function _view($id, $details = null, $templatecode = 'view.posttype.tpl') {
    ...
    private function _edit($id, $details = null, $templatecode = 'edit.posttype.tpl', $restoredraft = true) {
        $filtercolumns = $this->getCustomFilterColumns('posttype');
    ...
    private function _import($templatecode = 'import.posttype.tpl') {
