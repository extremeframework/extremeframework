...
class _WidgetPositionController extends __AppController
{
    ...
    protected function _view($id, $details = null, $templatecode = 'view.widgetposition.tpl') {
    ...
    protected function _edit($id, $details = null, $templatecode = 'edit.widgetposition.tpl', $restoredraft = true) {
        $filtercolumns = $this->getCustomFilterColumns('widgetposition');
    ...
    protected function _import($templatecode = 'import.widgetposition.tpl') {
