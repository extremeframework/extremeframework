...
class _PostRelationController extends __AppController
{
    ...
    protected function _view($id, $details = null, $templatecode = 'view.postrelation.tpl') {
    ...
    protected function _edit($id, $details = null, $templatecode = 'edit.postrelation.tpl', $restoredraft = true) {
        $filtercolumns = $this->getCustomFilterColumns('postrelation');
    ...
    protected function _import($templatecode = 'import.postrelation.tpl') {
