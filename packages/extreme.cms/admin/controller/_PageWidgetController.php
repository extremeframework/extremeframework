        ...
        foreach($filters as $key => $value) {
            ...
            if ($value != '') {
                switch ($key) {
                    ...
                    case 'WFID':
                        $model->whereAdd(TABLE_PREFIX."PAGE_WIDGET.WFID LIKE '%".$model->escape(StringHelper::htmlspecialchars($value))."%'");
