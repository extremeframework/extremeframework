...
class AdminViewApi extends AdminViewController
{
    var $module = 'adminview';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('adminview', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('adminview', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('adminview', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('adminview', 'view');
