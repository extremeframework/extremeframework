...
CREATE TABLE IF NOT EXISTS `ADMIN_LANGUAGE_ITEM` (
  ...
  KEY `IDX_UDID` (`UDID`),
  KEY `IDX_WFID` (`WFID`)
) ENGINE=InnoDB AUTO_INCREMENT=2078 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE IF NOT EXISTS `FIELD` (
  ...
  KEY `IDX_UDID` (`UDID`),
  KEY `IDX_WFID` (`WFID`)
) ENGINE=InnoDB AUTO_INCREMENT=28248 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (1,'PRM0000000001','Default currency','DEFAULT_CUR',1,8,'$','',1,NULL,0,NULL,'06e7f479-1a1a-11e5-b2f8-cc52af77857f');
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (2,'PRM0000000002','Application name','CONFIG_APPL',1,1,'Apps4Clouds','',1,NULL,0,NULL,'06e7f7cd-1a1a-11e5-b2f8-cc52af77857f');
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (3,'PRM0000000003','CSV separator','CSV_SEPARAT',1,1,',','',1,NULL,0,NULL,'06e7f8e3-1a1a-11e5-b2f8-cc52af77857f');
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (4,'PRM0000000004','Date format','DATE_FORMAT',1,1,'mm-dd-yy','',1,NULL,0,NULL,'06e7f9ce-1a1a-11e5-b2f8-cc52af77857f');
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (5,'PRM0000000005','Date format (in Smarty)','SMARTY_DATE',1,1,'%m-%d-%Y','',1,NULL,0,NULL,'06e7fab5-1a1a-11e5-b2f8-cc52af77857f');
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (7,'PRM0000000006','Default user group','DEFAULT_USE',1,3,'2','',1,NULL,0,NULL,'06e7fba9-1a1a-11e5-b2f8-cc52af77857f');
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (8,'PRM0000000007','Positive currency format','POSITIVE_CU',1,1,'%s%n','',1,NULL,0,NULL,'06e7fc8b-1a1a-11e5-b2f8-cc52af77857f');
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (9,'PRM0000000008','Negative currency format','NEGATIVE_CU',1,1,'(%s%n)','',1,NULL,0,NULL,'06e7fd72-1a1a-11e5-b2f8-cc52af77857f');
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (10,'PRM0000000009','Organization name','ORGANIZATIO',1,1,'Apps4Clouds Corporation','',1,NULL,0,NULL,'06e7fe5e-1a1a-11e5-b2f8-cc52af77857f');
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (12,'PRM0000000010','Support name','SUPPORT_NAM',1,1,'Apps4Clouds Support','',1,NULL,0,NULL,'06e7ff4d-1a1a-11e5-b2f8-cc52af77857f');
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (13,'PRM0000000011','Support email','SUPPORT_EMA',1,1,'support@apps4clouds.com','',1,NULL,0,NULL,'06e80034-1a1a-11e5-b2f8-cc52af77857f');
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (14,'PRM0000000012','Default public dashboard','DEFAULT_PUB',1,3,'3','',1,NULL,0,NULL,'06e80113-1a1a-11e5-b2f8-cc52af77857f');
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (15,'PRM0000000013','GetResponse API key','GETRESPONSE',1,1,'','',1,NULL,0,NULL,'06e801f1-1a1a-11e5-b2f8-cc52af77857f');
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (16,'PRM0000000014','Use SMTP for sending emails?','MAILER_USE_',1,1,'1','',1,NULL,0,NULL,'06e802cf-1a1a-11e5-b2f8-cc52af77857f');
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (17,'PRM0000000015','SMTP host','MAILER_SMTP',1,1,'smtp.gmail.com','',1,NULL,0,NULL,'06e803bf-1a1a-11e5-b2f8-cc52af77857f');
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (21,'PRM0000000016','Save draft interval (seconds)','SAVE_DRAFT_',1,3,'10','',1,NULL,0,NULL,'06e80499-1a1a-11e5-b2f8-cc52af77857f');
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (22,'PRM0000000017','Social :: Facebook URL','SOCIAL_FACE',2,1,'https://www.facebook.com/pages/C%E1%BB%99ng-%C4%91%E1%BB%93ng-PHP-Vi%E1%BB%87t-Nam/261573760536525','',1,NULL,0,NULL,'06e80580-1a1a-11e5-b2f8-cc52af77857f');
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (23,'PRM0000000018','Social :: Disqus short name','SOCIAL_DISQ',2,1,'vietmaisolutionscorporation','',1,NULL,0,NULL,'06e80674-1a1a-11e5-b2f8-cc52af77857f');
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (25,'PRM0000000019','Cloud sync option','CLOUD_SYNC_',3,2,'1','',1,NULL,0,NULL,'06e8076c-1a1a-11e5-b2f8-cc52af77857f');
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (26,'PRM0000000020','PayPal :: Mode','PAYPAL_MODE',4,1,'sandbox','',1,NULL,0,NULL,'06e8084a-1a1a-11e5-b2f8-cc52af77857f');
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (27,'PRM0000000021','PayPal :: API Username','PAYPAL_API_',4,1,'nguyenlehuutai-facilitator_api1.gmail.com','',1,NULL,0,NULL,'06e8093a-1a1a-11e5-b2f8-cc52af77857f');
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (30,'PRM0000000022','PayPal :: Currency Code','PAYPAL_CURR',4,1,'USD','',1,NULL,0,NULL,'06e80a32-1a1a-11e5-b2f8-cc52af77857f');
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (31,'PRM0000000023','Social :: Twitter URL','SOCIAL_TWIT',2,1,'','',1,NULL,0,NULL,'06e80b21-1a1a-11e5-b2f8-cc52af77857f');
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (32,'PRM0000000024','Social :: Google Plus URL','SOCIAL_GOOG',2,1,'','',1,NULL,0,NULL,'06e80c00-1a1a-11e5-b2f8-cc52af77857f');
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (33,'PRM0000000025','Social :: YouTube URL','SOCIAL_YOUT',2,1,'','',1,NULL,0,NULL,'06e80ce3-1a1a-11e5-b2f8-cc52af77857f');
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (34,'PRM0000000026','Social :: Pinterest URL','SOCIAL_PINT',2,1,'','',1,NULL,0,NULL,'06e80dbd-1a1a-11e5-b2f8-cc52af77857f');
INSERT IGNORE INTO `PARAMETER` (`ID`, `REFID`, `NAME`, `CODE`, `ID_PARAMETER_GROUP`, `ID_PARAMETER_TYPE`, `VALUE`, `DESCRIPTION`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES (35,'PRM0000000027','Social :: LinkedIn URL','SOCIAL_LINK',2,1,'','',1,NULL,0,NULL,'06e80e9f-1a1a-11e5-b2f8-cc52af77857f');
...
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007282', 'All', 'user', 'FIRST_NAME,LAST_NAME,PHOTO,EMAIL,LOGIN,PHONE,IS_ENABLED', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007287', 'All', 'field', 'NAME,MODULE,COLUMN,TOOLTIP,IS_EXCLUDED', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007288', 'All', 'screen', 'TITLE,ID_WORKFLOW,CODE', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007289', 'All', 'option', 'NAME,CODE,VALUE,CONTEXT', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007294', 'All', 'workflow', 'NAME,CODE', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007295', 'All', 'acltype', 'NAME,ORDERING', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007296', 'All', 'userlog', 'ID_USER,DATE_TIME,IP', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007297', 'All', 'userrole', 'NAME', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007300', 'All', 'parameter', 'NAME,CODE,VALUE', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007301', 'All', 'fieldacl', 'MODULE,ACTION,ID_USER_GROUP,ID_USER,ID_ACL_TYPE', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007303', 'All', 'dashboard', 'NAME,ID_ADMIN_MENU,ID_DASHBOARD_LAYOUT,DASHBOARD_FILE_PATH', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007305', 'All', 'usergroup', 'NAME,DEFAULT_ID_DASHBOARD', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007307', 'All', 'objectacl', 'MODULE,OBJECT_ID,ID_USER_GROUP,ID_USER,ARG_ID_USER_GROUP,ARG_ID_USER,ID_ACL_TYPE', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007308', 'All', 'valuetype', 'NAME,CODE', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007309', 'All', 'adminmenu', 'NAME,ORDERING,IS_ENABLED', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007310', 'All', 'changelog', 'ACTION,ITEM,MODULE,DATE_TIME,ID_USER', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007311', 'All', 'adminlabel', 'LABEL', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007315', 'All', 'recyclebin', 'ITEM,MODULE,DATE_TIME,ID_USER', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007317', 'All', 'screenfield', 'ID_SCREEN,TITLE,CODE,ID_VALUE_TYPE,DATASOURCE,VALUECOL,ORDERING', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007319', 'All', 'workflowlog', 'ID_WORKFLOW,ID_WORKFLOW_TRANSITION,MODULE,OBJECT_ID,DATE,ID_USER', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007324', 'All', 'adminmodule', 'NAME,MODULE,PREFIX,AVAILABLE_ACTIONS,IS_COMMENT_ENABLED', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007326', 'All', 'adminfilter', 'NAME,MODULE,COLUMNS,IS_DEFAULT', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007327', 'All', 'accessright', 'ID_USER_GROUP,MODULE,ACTIONS', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007335', 'All', 'workflowstage', 'ID_WORKFLOW,NAME,CODE,IS_DEFAULT,IS_BINDING_OBJECT_EDITABLE,IS_BINDING_OBJECT_DELETABLE', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007336', 'All', 'adminlanguage', 'NAME,CODE', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007338', 'All', 'adminsequence', 'MODULE,SEQUENCE_FORMAT,CURRENT_VALUE,SEQUENCE_STEP', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007339', 'All', 'parametertype', 'NAME,BASE_TYPE_CODE,EXTRA,ORDERING', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007340', 'All', 'userpreference', 'ID_USER,ID_DASHBOARD,ID_WALLPAPER,ID_ADMIN_STYLE', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007342', 'All', 'adminmenuitem', 'NAME,MODULE,ORDERING,ENABLE_LEFT,ENABLE_TOP,ENABLE_QUICK,ENABLE_ALL', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007343', 'All', 'parametergroup', 'NAME,ORDERING', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007344', 'All', 'usermembership', 'ID_USER,ID_USER_GROUP,ID_USER_ROLE,VALID_FROM,VALID_UNTIL', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007354', 'All', 'workflowtransition', 'ID_WORKFLOW,NAME,CODE,START_ID_WORKFLOW_STAGE,END_ID_WORKFLOW_STAGE,TRANSITION_ID_SCREEN,ORDERING', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007355', 'All', 'adminlanguageitem', 'ID_ADMIN_LANGUAGE,ID_ADMIN_LABEL', '1', '1', '', '', '0', '');
INSERT IGNORE INTO `ADMIN_FILTER` (`REFID`, `NAME`, `MODULE`, `COLUMNS`, `IS_DEFAULT`, `GUID`, `JSON`, `WFID`, `UDID`, `UUID`) VALUES ('ADF0000007356', 'All', 'workflowapplication', 'MODULE,ID_WORKFLOW', '1', '1', '', '', '0', '');
...
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000081', 'Users', '1', '0', 'user', '', 'fa-moon-o', '0', '0', '0', '0', '1', '', '', '99', '1', '', '0', '', 'c49b11e6-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000086', 'Fields', '1', '0', 'field', '', 'fa-tag', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c49dcb68-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000087', 'Screens', '1', '0', 'screen', '', 'fa-thumbs-o-up', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c49e0418-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000088', 'Options', '1', '0', 'option', '', 'fa-sort-amount-asc', '1', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c49e3864-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000093', 'Workflows', '1', '0', 'workflow', '', 'fa-wifi', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c49f1825-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000094', 'Acl Types', '1', '0', 'acltype', '', 'fa-text-width', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c49f44f5-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000095', 'User Logs', '1', '0', 'userlog', '', 'fa-git', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c49f72e7-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000096', 'User Roles', '1', '0', 'userrole', '', 'fa-file-text-o', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c49fa1ef-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000099', 'Parameters', '1', '0', 'parameter', '', 'fa-external-link-square', '1', '0', '0', '0', '1', '', '', '99', '1', '', '0', '', 'c4a02a0a-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000100', 'Field Acls', '1', '0', 'fieldacl', '', 'fa-jsfiddle', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c4a05834-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000102', 'Dashboards', '1', '0', 'dashboard', '', 'fa-th-large', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c4a4f08f-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000104', 'User Groups', '1', '0', 'usergroup', '', 'fa-css3', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c4a53335-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000106', 'Object Acls', '1', '0', 'objectacl', '', 'fa-paperclip', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c4a56d5e-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000107', 'Value Types', '1', '0', 'valuetype', '', 'fa-file-o', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c4a58b0f-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000108', 'Admin Menus', '1', '0', 'adminmenu', '', 'fa-bell-slash', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c4a5a854-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000109', 'Change Logs', '1', '0', 'changelog', '', 'fa-sun-o', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c4a5c589-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000110', 'Admin Labels', '1', '0', 'adminlabel', '', 'fa-chevron-circle-up', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c4a5e331-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000114', 'Recycle Bins', '1', '0', 'recyclebin', '', 'fa-trophy', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c4a658b3-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000116', 'Screen Fields', '1', '0', 'screenfield', '', 'fa-mobile', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c4a695eb-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000118', 'Workflow Logs', '1', '0', 'workflowlog', '', 'fa-chain-broken', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c4a6db12-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000123', 'Admin Modules', '1', '0', 'adminmodule', '', 'fa-facebook', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c4a77a88-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000125', 'Admin Filters', '1', '0', 'adminfilter', '', 'fa-quote-left', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c4a7bb7e-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000126', 'Access Rights', '1', '0', 'accessright', '', 'fa-sort-amount-desc', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c4a7dc68-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000134', 'Workflow Stages', '1', '0', 'workflowstage', '', 'fa-youtube-square', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c4a8e3cb-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000135', 'Admin Languages', '1', '0', 'adminlanguage', '', 'fa-wifi', '0', '0', '0', '0', '1', '', '', '99', '1', '', '0', '', 'c4a903ac-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000137', 'Admin Sequences', '1', '0', 'adminsequence', '', 'fa-volume-off', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c4a94bfb-2f53-11e5-8947-cc52af77857f', '');
...
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000139', 'User Preferences', '1', '0', 'userpreference', '', 'fa-openid', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c4a98bac-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000141', 'Admin Menu Items', '1', '0', 'adminmenuitem', '', 'fa-folder', '0', '0', '0', '0', '1', '', '', '99', '1', '', '0', '', 'c4a9e040-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000142', 'Parameter Groups', '1', '0', 'parametergroup', '', 'fa-arrow-circle-right', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c4aa05a0-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000143', 'User Memberships', '1', '0', 'usermembership', '', 'fa-truck', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c4aa280f-2f53-11e5-8947-cc52af77857f', '');
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000153', 'Workflow Transitions', '1', '0', 'workflowtransition', '', 'fa-random', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c4acbbe8-2f53-11e5-8947-cc52af77857f', '');
...
INSERT IGNORE INTO `ADMIN_MENU_ITEM` (`REFID`, `NAME`, `ID_ADMIN_MENU`, `PARENT`, `MODULE`, `PATH`, `FONT_AWESOME_ICON`, `ENABLE_LEFT`, `ENABLE_TOP`, `ENABLE_QUICK`, `ENABLE_ALL`, `ENABLE_SETTINGS`, `OPEN_IN_NEW_WINDOW`, `IS_STARRED`, `ORDERING`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`, `HIERACHY`) VALUES ('AMI0000000155', 'Workflow Applications', '1', '0', 'workflowapplication', '', 'fa-h-square', '0', '0', '0', '0', '0', '', '', '99', '1', '', '0', '', 'c4ad1469-2f53-11e5-8947-cc52af77857f', '');
...
INSERT IGNORE INTO `ADMIN_SEQUENCE` (`REFID`, `MODULE`, `SEQUENCE_FORMAT`, `CURRENT_VALUE`, `SEQUENCE_STEP`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES ('ADS0000000006', 'field', 'FLDxxxxxxxxxx', 'FLD0000000000', '1', '1', '', '0', '', '5db1af40-2f54-11e5-8947-cc52af77857f');
...
INSERT IGNORE INTO `ADMIN_SEQUENCE` (`REFID`, `MODULE`, `SEQUENCE_FORMAT`, `CURRENT_VALUE`, `SEQUENCE_STEP`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES ('ADS0000000015', 'userlog', 'USLxxxxxxxxxx', 'USL0000000000', '1', '1', '', '0', '', '5db2fcfe-2f54-11e5-8947-cc52af77857f');
...
INSERT IGNORE INTO `ADMIN_SEQUENCE` (`REFID`, `MODULE`, `SEQUENCE_FORMAT`, `CURRENT_VALUE`, `SEQUENCE_STEP`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES ('ADS0000000019', 'parameter', 'PRMxxxxxxxxxx', 'PRM0000000000', '1', '1', '', '0', '', '5db3cfba-2f54-11e5-8947-cc52af77857f');
INSERT IGNORE INTO `ADMIN_SEQUENCE` (`REFID`, `MODULE`, `SEQUENCE_FORMAT`, `CURRENT_VALUE`, `SEQUENCE_STEP`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES ('ADS0000000020', 'fieldacl', 'FLAxxxxxxxxxx', 'FLA0000000231', '1', '1', '', '0', '', '5db40507-2f54-11e5-8947-cc52af77857f');
...
INSERT IGNORE INTO `ADMIN_SEQUENCE` (`REFID`, `MODULE`, `SEQUENCE_FORMAT`, `CURRENT_VALUE`, `SEQUENCE_STEP`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES ('ADS0000000026', 'objectacl', 'OBAxxxxxxxxxx', 'OBA0000000181', '1', '1', '', '0', '', '5db63b31-2f54-11e5-8947-cc52af77857f');
...
INSERT IGNORE INTO `ADMIN_SEQUENCE` (`REFID`, `MODULE`, `SEQUENCE_FORMAT`, `CURRENT_VALUE`, `SEQUENCE_STEP`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES ('ADS0000000029', 'changelog', 'CHLxxxxxxxxxx', 'CHL0000000000', '1', '1', '', '0', '', '5db6e56e-2f54-11e5-8947-cc52af77857f');
INSERT IGNORE INTO `ADMIN_SEQUENCE` (`REFID`, `MODULE`, `SEQUENCE_FORMAT`, `CURRENT_VALUE`, `SEQUENCE_STEP`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES ('ADS0000000030', 'adminlabel', 'ADLxxxxxxxxxx', 'ADL0000000000', '1', '1', '', '0', '', '5db71986-2f54-11e5-8947-cc52af77857f');
...
INSERT IGNORE INTO `ADMIN_SEQUENCE` (`REFID`, `MODULE`, `SEQUENCE_FORMAT`, `CURRENT_VALUE`, `SEQUENCE_STEP`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES ('ADS0000000043', 'adminmodule', 'ADDxxxxxxxxxx', 'ADD0000000000', '1', '1', '', '0', '', '5db9b3ec-2f54-11e5-8947-cc52af77857f');
INSERT IGNORE INTO `ADMIN_SEQUENCE` (`REFID`, `MODULE`, `SEQUENCE_FORMAT`, `CURRENT_VALUE`, `SEQUENCE_STEP`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES ('ADS0000000045', 'adminfilter', 'ADFxxxxxxxxxx', 'ADF0000000000', '1', '1', '', '0', '', '5dba1a7a-2f54-11e5-8947-cc52af77857f');
INSERT IGNORE INTO `ADMIN_SEQUENCE` (`REFID`, `MODULE`, `SEQUENCE_FORMAT`, `CURRENT_VALUE`, `SEQUENCE_STEP`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES ('ADS0000000046', 'accessright', 'ACRxxxxxxxxxx', 'ACR0000000000', '1', '1', '', '0', '', '5dba4bfb-2f54-11e5-8947-cc52af77857f');
...
INSERT IGNORE INTO `ADMIN_SEQUENCE` (`REFID`, `MODULE`, `SEQUENCE_FORMAT`, `CURRENT_VALUE`, `SEQUENCE_STEP`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES ('ADS0000000057', 'adminsequence', 'ADSxxxxxxxxxx', 'ADS0000000077', '1', '1', '', '0', '', '5dbcb7e1-2f54-11e5-8947-cc52af77857f');
...
INSERT IGNORE INTO `ADMIN_SEQUENCE` (`REFID`, `MODULE`, `SEQUENCE_FORMAT`, `CURRENT_VALUE`, `SEQUENCE_STEP`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES ('ADS0000000061', 'adminmenuitem', 'AMIxxxxxxxxxx', 'AMI0000000000', '1', '1', '', '0', '', '5dbd8028-2f54-11e5-8947-cc52af77857f');
...
INSERT IGNORE INTO `ADMIN_SEQUENCE` (`REFID`, `MODULE`, `SEQUENCE_FORMAT`, `CURRENT_VALUE`, `SEQUENCE_STEP`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES ('ADS0000000074', 'adminlanguageitem', 'ALIxxxxxxxxxx', 'ALI0000000000', '1', '1', '', '0', '', '5dc02738-2f54-11e5-8947-cc52af77857f');
INSERT IGNORE INTO `ADMIN_SEQUENCE` (`REFID`, `MODULE`, `SEQUENCE_FORMAT`, `CURRENT_VALUE`, `SEQUENCE_STEP`, `GUID`, `JSON`, `UDID`, `WFID`, `UUID`) VALUES ('ADS0000000075', 'workflowapplication', 'WRAxxxxxxxxxx', 'WRA0000000000', '1', '1', '', '0', '', '5dc0550d-2f54-11e5-8947-cc52af77857f');
