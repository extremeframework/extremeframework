...
define('PAYPAL_USERNAME', 'tqviet1978-facilitator_api1.gmail.com');
define('PAYPAL_PASSWORD', '1376117508');
define('PAYPAL_SIGNATURE', 'AFcWxV21C7fd0v3bYYYRCpSSRl31Ab7Si691b-CXA5J-BWDttF8b7A4z');
...
flush();
    ...
    function creditCardBegin() {
        ...
        // OK: curl -s --insecure https://api-3t.sandbox.paypal.com/nvp -d "USER=tqviet1978-facilitator_api1.gmail.com&PWD=1376117508&SIGNATURE=AFcWxV21C7fd0v3bYYYRCpSSRl31Ab7Si691b-CXA5J-BWDttF8b7A4z&METHOD=DoDirectPayment&VERSION=78&PAYMENTACTION=SALE&AMT=5&ACCT=4660997962602322&CREDITCARDTYPE=VISA&CVV2=176&FIRSTNAME=James&LASTNAME=Smith&STREET=FirstStreet&CITY=SanJose&STATE=CA&ZIP=95131&COUNTRYCODE=US&EXPDATE=092015
        // Sai credit card number thi he thong khong response
        // Nen su dung credit card number cua buyer account trong sandbox
