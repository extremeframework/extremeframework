...
class DashboardItemApi extends DashboardItemController
{
    var $module = 'dashboarditem';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('dashboarditem', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('dashboarditem', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('dashboarditem', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('dashboarditem', 'view');
