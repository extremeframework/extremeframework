...
class DashboardItemTypeApi extends DashboardItemTypeController
{
    var $module = 'dashboarditemtype';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('dashboarditemtype', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('dashboarditemtype', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('dashboarditemtype', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('dashboarditemtype', 'view');
