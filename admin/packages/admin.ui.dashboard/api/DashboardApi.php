...
class DashboardApi extends DashboardController
{
    var $module = 'dashboard';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('dashboard', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('dashboard', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('dashboard', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('dashboard', 'view');
