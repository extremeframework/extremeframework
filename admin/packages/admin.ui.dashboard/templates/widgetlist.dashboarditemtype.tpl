...
<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="dashboarditemtypequicksearch" class="form-quicksearch scope-main" action="<{$smarty.const.APPLICATION_URL}>/dashboarditemtype/search" method="get">
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/dashboarditemtype/new/<{if isset($preset) && isset($presetvalue)}>preset/<{$preset}>/presetvalue/<{$presetvalue}><{/if}><{if isset($presetstring)}>?<{$presetstring}><{/if}>"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{_t('New', true)}> <{_t('Dashboard Item Type', true)|strtolower}>"/><{_t('New')}> <{_t('Dashboard Item Type')|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
...
<!-- List -->
<form name="dashboarditemtypelist" id="dashboarditemtypelistform" class="form-list scope-main" action="<{$smarty.const.APPLICATION_URL}>/dashboarditemtype/" method="post">
...
<{if $pagination || $total > 10}>
	...
	<div style="clear:both"></div>
            ...
            <script type="text/javascript">
            $(function() {
            	bind_hotkey('#dashboarditemtypelistform', 'left', '.pagination-prev');
            	bind_hotkey('#dashboarditemtypelistform', 'right', '.pagination-next');
            });
        </script>
    <{else}>
	<br>
