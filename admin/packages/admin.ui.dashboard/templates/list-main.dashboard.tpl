        ...
        <{assign var='colcount' value=1}>
    	        ...
    	        <{if !isset($excludedcolumns['NAME']) && ((isset($aclviewablecolumns['NAME']) && $aclviewablecolumns['NAME']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['NAME']) || $aclviewablecolumns['NAME']))) }>
    	            <th class="column-name">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/dashboard/sort/name"><{_t('Dashboard name')}></a>
            ...
            <{/if}>
    	        ...
    	        <{if !isset($excludedcolumns['TITLE']) && ((isset($aclviewablecolumns['TITLE']) && $aclviewablecolumns['TITLE']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['TITLE']) || $aclviewablecolumns['TITLE']))) }>
    	            <th class="column-title">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/dashboard/sort/title"><{_t('Dashboard title')}></a>
            ...
            <{/if}>
    	        ...
    	        <{if !isset($excludedcolumns['SUBTITLE']) && ((isset($aclviewablecolumns['SUBTITLE']) && $aclviewablecolumns['SUBTITLE']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['SUBTITLE']) || $aclviewablecolumns['SUBTITLE']))) }>
    	            <th class="column-subtitle">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/dashboard/sort/subtitle"><{_t('Subtitle')}></a>
            ...
            <{/if}>
    	        ...
    	        <{if !isset($excludedcolumns['ID_ADMIN_PACKAGE']) && ((isset($aclviewablecolumns['ID_ADMIN_PACKAGE']) && $aclviewablecolumns['ID_ADMIN_PACKAGE']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['ID_ADMIN_PACKAGE']) || $aclviewablecolumns['ID_ADMIN_PACKAGE']))) }>
    	            <th class="column-id-admin-package">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/dashboard/sort/id_admin_package"><{_t('Admin package')}></a>
