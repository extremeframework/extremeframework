<div class="view-main">
    <{plugin key="dashboarditemtype_view_top" args=$details}>
        ...
        <{if !isset($columns2hide) || !in_array('NAME', $columns2hide) }>
    		<td class="form-field form-field-label column-name">
	            		        <label class="attribute-name"><{_t('Dashboard item type name')}></label>
            </td>
...
<{/if}>            </tbody>
    ...
    <{plugin key="dashboarditemtype_view_bottom" args=$details}>

    <script type="text/javascript">
        ///////////////////////////////////////////////////////////////////////////////
        // VISIBILITY REFLECTION
        dashboarditemtypeview_get_visibility_settings = function (model) {
            var settings = {};
        ...
        dashboarditemtypeview_apply_visibility_settings = function (settings) {
            $.each(settings, function(key, value) {
                dashboarditemtypeview_apply_block_visibility(key, value);
            });
        }

        dashboarditemtypeview_apply_block_visibility = function (key, value) {
        ...
        dashboarditemtypeview_update_visibility_settings = function () {
            var settings = dashboarditemtypeview_get_visibility_settings();

            dashboarditemtypeview_apply_visibility_settings(settings);
        }

        $(function() {
            dashboarditemtypeview_update_visibility_settings();
        });
...
//                        type: "post",
//                        dataType: "json",
//                        url: "<{$smarty.const.APPLICATION_URL}>/dashboarditemtype/fieldSave",
//                        data: td.find(':input').serialize() + "&dashboarditemtype_formdata_UUID=<{$details->UUID}>"
//                    }).done(function(data) {
//                        if (data.success) {
//                            if (input.is("select")) {
