...
<{assign var='title' value=_t('Dashboard Item')}>
<{include file="top.tpl"}>

<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="dashboarditemquicksearch" class="form-quicksearch scope-list" action="<{$smarty.const.APPLICATION_URL}>/dashboarditem/search" method="get">
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/dashboarditem/new/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{_t('New', true)}> <{_t('Dashboard Item', true)|strtolower}>"/><{_t('New')}> <{_t('Dashboard Item')|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
        	    ...
        	    <{/if}>
                            ...
                            <a href="#" onclick="dashboarditem_delete()"><span class="button-face"><{_t('Delete')}></span></a>
                                            ...
                                            <{/if}>
                                                                                <{if isset($smarty.session.acl.dashboarditem.import)}>
                                            <div class="btn button-general">
                            <a class="button-import scope-main" href="<{$smarty.const.APPLICATION_URL}>/dashboarditem/import/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-import.png" alt="<{_t('Import', true)}>" /><{_t('Import')}></span></a>
                        </div>
                                            <{/if}>
                                                                                <{if isset($smarty.session.acl.dashboarditem.export)}>
                                            <div class="btn button-general">
                            <a class="button-export" href="<{$smarty.const.APPLICATION_URL}>/dashboarditem/export/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-export.png" alt="<{_t('Export', true)}>" /><{_t('Export')}></span></a>
                        </div>
                                            <{/if}>
...
<!-- List -->
<form name="dashboarditemlist" id="dashboarditemlistform" class="form-list scope-list" action="<{$smarty.const.APPLICATION_URL}>/dashboarditem/" method="post">
