...
class AdminFilterApi extends AdminFilterController
{
    var $module = 'adminfilter';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('adminfilter', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('adminfilter', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('adminfilter', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('adminfilter', 'view');
