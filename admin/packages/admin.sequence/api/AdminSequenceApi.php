...
class AdminSequenceApi extends AdminSequenceController
{
    var $module = 'adminsequence';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('adminsequence', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('adminsequence', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('adminsequence', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('adminsequence', 'view');
