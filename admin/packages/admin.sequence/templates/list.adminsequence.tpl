...
<{assign var='title' value=_t('L_ADMIN_SEQUENCE')}>
...
<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="adminsequencequicksearch" class="form-quicksearch scope-list" action="<{$smarty.const.APPLICATION_URL}>/adminsequence/search" method="post" enctype="multipart/form-data">
            <input type="text" name="adminsequence_searchdata___QUICKSEARCH__" value="<{if isset($searchdata.__QUICKSEARCH__)}><{$searchdata.__QUICKSEARCH__}><{/if}>" size="25" placeholder="<{_t('L_SEARCH')}>" />
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main" href="<{$smarty.const.APPLICATION_URL}>/adminsequence/new/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{_t('L_NEW')}> <{_t('L_ADMIN_SEQUENCE')|strtolower}>"/><{_t('L_NEW')}> <{_t('L_ADMIN_SEQUENCE')|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
