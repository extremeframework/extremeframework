<div class="modal-header">
    ...
    <h3><{label key="L_QUICK_CREATE" format="ucwords"}> <{$smarty.const.L_ADMIN_SEQUENCE|ucwords}></h3>
</div>
...
<div id="adminsequence-edit" class="edit_details">
    ...
    <{if isset($messages.adminsequence) }>
        <ul class="message">
            <{foreach from=$messages.adminsequence key=field item=message}>
...
<{if !isset($excludedcolumns['MODULE'])}>
        ...
        <{else}>
            ...
            <{html_ref_select autocomplete="1" ajax="0" method="" id="input-module" class="input-module" name="`$prefix`adminsequence_formdata_MODULE" value=$details->MODULE text=$details->reftext_MODULE datasource="ADMIN_MODULE" valuecol="MODULE" textcol="NAME" sortcol="" groupcol="" blankitem=""}>
...
<{if !isset($excludedcolumns['SEQUENCE_FORMAT'])}>
        ...
        <{else}>
    		<td class="form-row form-row-sequence-format">
                <div class="form-field form-field-label">
        		    <label><{label key="L_SEQUENCE_FORMAT"}></label>
                </div>
            </td>
...
<{if !isset($excludedcolumns['CURRENT_VALUE'])}>
        ...
        <{else}>
    		<td class="form-row form-row-current-value">
                <div class="form-field form-field-label">
        		    <label><{label key="L_CURRENT_VALUE"}></label>
                </div>
            </td>
...
<{if !isset($excludedcolumns['SEQUENCE_STEP'])}>
        ...
        <{else}>
    		<td class="form-row form-row-sequence-step">
                <div class="form-field form-field-label">
        		    <label><{label key="L_SEQUENCE_STEP"}></label>
                </div>
            </td>
