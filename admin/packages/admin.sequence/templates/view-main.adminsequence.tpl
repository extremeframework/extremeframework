<div class="view-main">
    ...
    <{/if}>
            ...
            <{html_ref_select multilingual="0" autocomplete="1" ajax="0" method="" id="input-module" class="input-module" name="`$prefix`adminsequence_formdata_MODULE" value=$details->MODULE text=$details->reftext_MODULE datasource="ADMIN_MODULE" datasourcename="AdminModule" valuecol="MODULE" textcol="NAME" sortcol="NAME"}>
	...
	<{/if}>
        ...
        <{if !isset($columns2hide) || !in_array('SEQUENCE_FORMAT', $columns2hide) }>
    		<td class="form-field form-field-label column-sequence-format">
	            		        <label class="attribute-name"><{_t('Sequence format')}></label>
            </td>
	...
	<{/if}>
        ...
        <{if !isset($columns2hide) || !in_array('CURRENT_VALUE', $columns2hide) }>
    		<td class="form-field form-field-label column-current-value">
	            		        <label class="attribute-name"><{_t('Current value')}></label>
            </td>
	...
	<{/if}>
        ...
        <{if !isset($columns2hide) || !in_array('SEQUENCE_STEP', $columns2hide) }>
    		<td class="form-field form-field-label column-sequence-step">
	            		        <label class="attribute-name"><{_t('Sequence step')}></label>
            </td>
