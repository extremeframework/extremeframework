...
<{assign var='title' value=_t('Admin Package Shortcut')}>
<{include file="top.tpl"}>

<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="adminpackageshortcutquicksearch" class="form-quicksearch scope-list" action="<{$smarty.const.APPLICATION_URL}>/adminpackageshortcut/search" method="get">
            ...
            <div class="buttons">
        	    ...
        	    <{/if}>
                            ...
                            <a href="#" onclick="adminpackageshortcut_delete()"><span class="button-face"><{_t('Delete')}></span></a>
                                            ...
                                            <{/if}>
                                                                                <{if isset($smarty.session.acl.adminpackageshortcut.import)}>
                                            <div class="btn button-general">
                            <a class="button-import scope-main" href="<{$smarty.const.APPLICATION_URL}>/adminpackageshortcut/import/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-import.png" alt="<{_t('Import', true)}>" /><{_t('Import')}></span></a>
                        </div>
                                            <{/if}>
                                                                                <{if isset($smarty.session.acl.adminpackageshortcut.export)}>
                                            <div class="btn button-general">
                            <a class="button-export" href="<{$smarty.const.APPLICATION_URL}>/adminpackageshortcut/export/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-export.png" alt="<{_t('Export', true)}>" /><{_t('Export')}></span></a>
                        </div>
                                            <{/if}>
...
<!-- List -->
<form name="adminpackageshortcutlist" id="adminpackageshortcutlistform" class="form-list scope-list" action="<{$smarty.const.APPLICATION_URL}>/adminpackageshortcut/" method="post">
