...
<body class="module module-<{$module}> additional-userpackage">
    ...
    <div class="edit-buttons edit-buttons-top hidden-print">
        <{foreach from=$formactions key=actiontitle item=actionurl}>
            <div class="button-general button-save btn btn-success">
                <a onclick="$('#userpackageform').attr('action', '<{$actionurl}>');$('#userpackageform').submit();return false;"><span class="button-face"><{$actiontitle}></span></a>
            </div>
        <{/foreach}>
        <a class="button-cancel scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/userpackage/cancel/?back=0"><span class="button-face"><{_t('Cancel')}></span></a>
    ...
    <div class="section" style="padding: 10px 0;">
        <div>
            <div class="edit-main edit_details">
                ...
                <form name="userpackageform" id="userpackageform" class="form-edit scope-main" action="" method="post" enctype="multipart/form-data">
                    <table class="table table-bordered table-custom-layout equal-split">
                        <tbody>
                            <{foreach from=$columns item=column }>
                                ...
                                <{html_ref_select multilingual="0" autocomplete="1" ajax="0" method="" class="input-id-user" name="`$prefix`userpackage_formdata_ID_USER" value=$formdata.ID_USER datasource="USER" datasourcename="User" valuecol="ID" textcol="FIRST_NAME+LAST_NAME" sortcol="FIRST_NAME" groupcol="" blankitem=""}>
                                ...
                                <{html_ref_select multilingual="0" autocomplete="1" ajax="0" method="" class="input-id-admin-package" name="`$prefix`userpackage_formdata_ID_ADMIN_PACKAGE" value=$formdata.ID_ADMIN_PACKAGE datasource="ADMIN_PACKAGE" datasourcename="AdminPackage" valuecol="CODE" textcol="NAME" sortcol="NAME" groupcol="" blankitem=""}>
...
<script type="text/javascript">
    $(function() {
    	bind_hotkey('#userpackageform', 'f2', '.button-save');
    	bind_hotkey('#userpackageform', 'esc', '.button-cancel');
    });
