<div class="modal-header">
    ...
    <h3><{_t('Quick create')|ucwords}> <{_t('Package Category')|ucwords}></h3>
</div>
...
<{if !isset($excludedcolumns['NAME'])}>
        ...
        <{if $preset == 'NAME'}>
            <input type="hidden" class="input-name" name="packagecategory_formdata_NAME" value="<{$presetvalue}>" />
        <{elseif isset($acleditablecolumns['NAME']) && !$acleditablecolumns['NAME'] || !isset($acleditablecolumns['*']) && !isset($acleditablecolumns['NAME'])}>
            <input type="hidden" class="input-name" name="packagecategory_formdata_NAME" value="<{$details->NAME}>" />
        <{else}>
    		<td class="form-row form-row-name form-row-mandatory">
                <div class="form-field form-field-label">
        		    <label><{_t('Package category name')}><span class="mandatory">*</span></label>
                </div>
            </td>
