<div class="view-main">
    <{plugin key="adminpackageindustry_view_top" args=$details}>
        ...
        <{if !isset($columns2hide) || !in_array('NAME', $columns2hide) }>
    		<td class="form-field form-field-label column-name">
	            		        <label class="attribute-name"><{_t('Admin package industry name')}></label>
            </td>
...
<{/if}>            </tbody>
    ...
    <{plugin key="adminpackageindustry_view_bottom" args=$details}>

    <script type="text/javascript">
        ///////////////////////////////////////////////////////////////////////////////
        // VISIBILITY REFLECTION
        adminpackageindustryview_get_visibility_settings = function (model) {
            var settings = {};
        ...
        adminpackageindustryview_apply_visibility_settings = function (settings) {
            $.each(settings, function(key, value) {
                adminpackageindustryview_apply_block_visibility(key, value);
            });
        }

        adminpackageindustryview_apply_block_visibility = function (key, value) {
        ...
        adminpackageindustryview_update_visibility_settings = function () {
            var settings = adminpackageindustryview_get_visibility_settings();

            adminpackageindustryview_apply_visibility_settings(settings);
        }

        $(function() {
            adminpackageindustryview_update_visibility_settings();
        });
...
//                        type: "post",
//                        dataType: "json",
//                        url: "<{$smarty.const.APPLICATION_URL}>/adminpackageindustry/fieldSave",
//                        data: td.find(':input').serialize() + "&adminpackageindustry_formdata_UUID=<{$details->UUID}>"
//                    }).done(function(data) {
//                        if (data.success) {
//                            if (input.is("select")) {
