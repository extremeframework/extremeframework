...
<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="adminpackagepermissionquicksearch" class="form-quicksearch scope-main" action="<{$smarty.const.APPLICATION_URL}>/adminpackagepermission/search" method="get">
...
<{if isset($title) }>
    <h1 class="heading">
        ...
        <span style="margin-left:10px; font-size:12px; font-weight: normal" class="hidden-print">
            <a style="text-decoration: none" class="button-view-refresh scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/adminpackagepermission"><i class="fa fa-refresh"></i></a>
        </span>
    </h1>
<{/if}>
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/adminpackagepermission/new/<{if isset($preset) && isset($presetvalue)}>preset/<{$preset}>/presetvalue/<{$presetvalue}><{/if}><{if isset($presetstring)}>?<{$presetstring}><{/if}>"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{_t('New', true)}> <{_t('Admin Package Permission', true)|strtolower}>"/><{_t('New')}> <{_t('Admin Package Permission')|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
...
<!-- List -->
<form name="adminpackagepermissionlist" id="adminpackagepermissionlistform" class="form-list scope-main" action="<{$smarty.const.APPLICATION_URL}>/adminpackagepermission/" method="post">
...
<{if $pagination || $total > 10}>
	...
	<div style="clear:both"></div>
            ...
            <script type="text/javascript">
            $(function() {
            	bind_hotkey('#adminpackagepermissionlistform', 'left', '.pagination-prev');
            	bind_hotkey('#adminpackagepermissionlistform', 'right', '.pagination-next');
            });
        </script>
    <{else}>
	<br>
