...
class PackageCategoryApi extends PackageCategoryController
{
    var $module = 'packagecategory';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('packagecategory', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('packagecategory', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('packagecategory', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('packagecategory', 'view');
