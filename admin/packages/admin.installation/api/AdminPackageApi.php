...
class AdminPackageApi extends AdminPackageController
{
    var $module = 'adminpackage';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('adminpackage', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('adminpackage', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('adminpackage', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('adminpackage', 'view');
