...
class AdminPackageShortcutApi extends AdminPackageShortcutController
{
    var $module = 'adminpackageshortcut';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('adminpackageshortcut', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('adminpackageshortcut', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('adminpackageshortcut', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('adminpackageshortcut', 'view');
