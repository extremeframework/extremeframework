...
class AdminPackageCategoryApi extends AdminPackageCategoryController
{
    var $module = 'adminpackagecategory';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('adminpackagecategory', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('adminpackagecategory', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('adminpackagecategory', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('adminpackagecategory', 'view');
