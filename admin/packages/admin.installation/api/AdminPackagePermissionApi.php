...
class AdminPackagePermissionApi extends AdminPackagePermissionController
{
    var $module = 'adminpackagepermission';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('adminpackagepermission', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('adminpackagepermission', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('adminpackagepermission', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('adminpackagepermission', 'view');
