...
class AdminPackageIndustryApi extends AdminPackageIndustryController
{
    var $module = 'adminpackageindustry';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('adminpackageindustry', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('adminpackageindustry', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('adminpackageindustry', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('adminpackageindustry', 'view');
