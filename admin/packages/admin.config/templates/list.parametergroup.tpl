...
<{assign var='title' value=$smarty.const.L_PARAMETER_GROUP}>
...
<!-- Relations -->
    ...
    <div id="parametergroupcopyrelations" style="display:none" title="<{$smarty.const.L_COPY}> <{$smarty.const.L_PARAMETER_GROUP|strtolower}>">
        <p><{$copyguidelines}></p>
        <ul>
    ...
    <div id="parametergroupapproverelations" style="display:none" title="<{$smarty.const.L_APPROVE}> <{$smarty.const.L_PARAMETER_GROUP|strtolower}>">
    ...
    <div id="parametergroupdeleterelations" style="display:none" title="<{$smarty.const.L_DELETE}> <{$smarty.const.L_PARAMETER_GROUP|strtolower}>">
