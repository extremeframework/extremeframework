...
<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="parametergroupquicksearch" class="form-quicksearch scope-list" action="<{$smarty.const.APPLICATION_URL}>/parametergroup/search" method="post" enctype="multipart/form-data">
            <input type="text" name="parametergroup_searchdata___QUICKSEARCH__" value="<{if isset($searchdata.__QUICKSEARCH__)}><{$searchdata.__QUICKSEARCH__}><{/if}>" size="25" placeholder="<{_t('L_SEARCH')}>" />
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main" href="<{$smarty.const.APPLICATION_URL}>/parametergroup/new/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{_t('L_NEW')}> <{_t('L_PARAMETER_GROUP')|strtolower}>"/><{_t('L_NEW')}> <{_t('L_PARAMETER_GROUP')|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
...
<!-- Relations -->
    <{php}>
    	$template->assign('copyguidelines',  sprintf(L_GUIDELINES_COPY_RELS, strtolower(L_PARAMETER_GROUP)));
    	$template->assign('approveguidelines', sprintf(L_GUIDELINES_APPROVE_RELS, strtolower(L_PARAMETER_GROUP)));
    	$template->assign('deleteguidelines', sprintf(L_GUIDELINES_DELETE_RELS, strtolower(L_PARAMETER_GROUP), strtolower(L_PARAMETER_GROUP)));
    <{/php}>

    <div id="parametergroupcopyrelations" style="display:none" title="<{_t('L_COPY')}> <{_t('L_PARAMETER_GROUP')|strtolower}>">
        <p><{$copyguidelines}></p>
        <ul>
    ...
    <div id="parametergroupapproverelations" style="display:none" title="<{_t('L_APPROVE')}> <{_t('L_PARAMETER_GROUP')|strtolower}>">
    ...
    <div id="parametergroupdeleterelations" style="display:none" title="<{_t('L_DELETE')}> <{_t('L_PARAMETER_GROUP')|strtolower}>">
