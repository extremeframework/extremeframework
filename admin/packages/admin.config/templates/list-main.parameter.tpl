...
<table class="item_list" id="parameterlist" data-module="parameter">
        ...
        <{assign var='colcount' value=1}>
    	        ...
    	        <{if !isset($excludedcolumns['NAME']) && ((isset($aclviewablecolumns['NAME']) && $aclviewablecolumns['NAME']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['NAME']) || $aclviewablecolumns['NAME']))) }>
    	            <th class="column-name">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/parameter/sort/name"><{label key="L_PARAMETER_NAME"}></a>
            ...
            <{/if}>
    	        ...
    	        <{if !isset($excludedcolumns['CODE']) && ((isset($aclviewablecolumns['CODE']) && $aclviewablecolumns['CODE']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['CODE']) || $aclviewablecolumns['CODE']))) }>
    	            <th class="column-code">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/parameter/sort/code"><{label key="L_CODE"}></a>
            ...
            <{/if}>
    	        ...
    	        <{if !isset($excludedcolumns['ID_PARAMETER_GROUP']) && ((isset($aclviewablecolumns['ID_PARAMETER_GROUP']) && $aclviewablecolumns['ID_PARAMETER_GROUP']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['ID_PARAMETER_GROUP']) || $aclviewablecolumns['ID_PARAMETER_GROUP']))) }>
    	            <th class="column-id-parameter-group">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/parameter/sort/id_parameter_group"><{label key="L_PARAMETER_GROUP"}></a>
            ...
            <{/if}>
    	        ...
    	        <{if !isset($excludedcolumns['ID_PARAMETER_TYPE']) && ((isset($aclviewablecolumns['ID_PARAMETER_TYPE']) && $aclviewablecolumns['ID_PARAMETER_TYPE']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['ID_PARAMETER_TYPE']) || $aclviewablecolumns['ID_PARAMETER_TYPE']))) }>
    	            <th class="column-id-parameter-type">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/parameter/sort/id_parameter_type"><{label key="L_PARAMETER_TYPE"}></a>
            ...
            <{/if}>
    	        ...
    	        <{if !isset($excludedcolumns['VALUE']) && ((isset($aclviewablecolumns['VALUE']) && $aclviewablecolumns['VALUE']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['VALUE']) || $aclviewablecolumns['VALUE']))) }>
    	            <th class="column-value">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/parameter/sort/value"><{label key="L_VALUE"}></a>
	...
	<tr class="top-holder" style="display:none">
	    <td colspan="<{$colcount+2}>" style="text-align:center;">
	    	<div class="selectall">All <{$rows|@count}> <{$smarty.const.L_PARAMETER|strtolower}>s on this page are selected. <a onclick="parameter_selectall()">Select all <{$total}> <{$smarty.const.L_PARAMETER|strtolower}>s in the list</a></div>
	    	<div class="clearselection">All <{$total}> <{$smarty.const.L_PARAMETER|strtolower}>s in the list are selected. <a onclick="parameter_clearselection()">Clear selection</a></div>
		</td>
	</tr>
	<{/if}>
	...
	<tfoot>
            	...
            	<tr class="additem">
            	    <td colspan="2"></td>
            		<td colspan="<{$colcount}>">
                        <span style="cursor:pointer;text-decoration:underline;color:blue" class="parameter-rowedit-add"><{label key="L_ADD_ITEM"}></span>
                	    <span class="parameter-rowedit-buttons" style="display:none">
                    	    <div class="rowedit-save parameter-rowedit-save btn btn-success"><{label key="L_SAVE"}></div>
                    	    <a class="rowedit-cancel parameter-rowedit-cancel button-cancel"><{label key="L_CANCEL"}></a>
                        </span>
