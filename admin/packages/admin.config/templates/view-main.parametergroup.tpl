<div class="view-main">
    <{plugin key="parametergroup_view_top" args=$details}>
        ...
        <{if !isset($columns2hide) || !in_array('NAME', $columns2hide) }>
    		<td class="form-field form-field-label column-name">
	            		        <label class="attribute-name"><{label key="L_PARAMETER_GROUP_NAME"}></label>
            </td>
    ...
    <{plugin key="parametergroup_view_bottom" args=$details}>

    <script type="text/javascript">
        ///////////////////////////////////////////////////////////////////////////////
        // VISIBILITY REFLECTION
        parametergroupview_get_visibility_settings = function (model) {
            var settings = {};
        ...
        parametergroupview_apply_visibility_settings = function (settings) {
            $.each(settings, function(key, value) {
                parametergroupview_apply_block_visibility(key, value);
            });
        }

        parametergroupview_apply_block_visibility = function (key, value) {
        ...
        parametergroupview_update_visibility_settings = function () {
            var settings = parametergroupview_get_visibility_settings();

            parametergroupview_apply_visibility_settings(settings);
        }

        $(function() {
            parametergroupview_update_visibility_settings();
        });
...
//                        type: "post",
//                        dataType: "json",
//                        url: "<{$smarty.const.APPLICATION_URL}>/parametergroup/fieldSave",
//                        data: td.find(':input').serialize() + "&parametergroup_formdata_UUID=<{$details->UUID}>"
//                    }).done(function(data) {
//                        if (data.success) {
//                            if (input.is("select")) {
