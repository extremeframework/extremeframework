...
<table class="item_list" id="parametergrouplist" data-module="parametergroup">
	...
	<tfoot>
            	...
            	<tr class="additem">
            	    <td colspan="2"></td>
            		<td colspan="<{$colcount}>">
                        <span style="cursor:pointer;text-decoration:underline;color:blue" class="parametergroup-rowedit-add"><{_t('L_ADD_ITEM')}></span>
                	    <span class="parametergroup-rowedit-buttons" style="display:none">
                    	    <div class="rowedit-save parametergroup-rowedit-save btn btn-success"><{_t('L_SAVE')}></div>
                    	    <a class="rowedit-cancel parametergroup-rowedit-cancel button-cancel"><{_t('L_CANCEL')}></a>
                        </span>
