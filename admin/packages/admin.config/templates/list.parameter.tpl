...
<{assign var='title' value=_t('L_PARAMETER')}>
...
<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="parameterquicksearch" class="form-quicksearch scope-list" action="<{$smarty.const.APPLICATION_URL}>/parameter/search" method="post" enctype="multipart/form-data">
            <input type="text" name="parameter_searchdata___QUICKSEARCH__" value="<{if isset($searchdata.__QUICKSEARCH__)}><{$searchdata.__QUICKSEARCH__}><{/if}>" size="25" placeholder="<{_t('L_SEARCH', true)}>" />
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main" href="<{$smarty.const.APPLICATION_URL}>/parameter/new/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{_t('L_NEW', true)}> <{_t('L_PARAMETER', true)|strtolower}>"/><{_t('L_NEW')}> <{_t('L_PARAMETER')|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
        	    ...
        	    <{/if}>
                                            ...
                                            <div class="btn button-general">
                            <a href="#" onclick="parameter_delete()"><span class="button-face"><{_t('L_DELETE')}></span></a>
                        </div>
                                            <{/if}>
...
<{if $pagination || $total > 10}>
	...
	<div style="float:left">
		<span class="parameter-list-count list-count"><{$total}></span> <{_t('L_RECORDS')}>
	</div>
	<div style="clear:both"></div>
<{/if}>
