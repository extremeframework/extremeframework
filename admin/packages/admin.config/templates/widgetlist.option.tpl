...
<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="optionquicksearch" class="form-quicksearch scope-main" action="<{$smarty.const.APPLICATION_URL}>/option/search" method="get">
...
<{if isset($title) }>
    <h1 class="heading">
        ...
        <span style="margin-left:10px; font-size:12px; font-weight: normal" class="hidden-print">
            <a style="text-decoration: none" class="button-view-refresh scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/option"><i class="fa fa-refresh"></i></a>
        </span>
    </h1>
<{/if}>
