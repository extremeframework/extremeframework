...
<div class="edit_details">
    ...
    <div class="edit-buttons edit-buttons-top">
        <div class="button-general button-save btn btn-success">
            <a class="button-save" onclick="$('#package-configuration-form').submit();return false;"><span class="button-face"><{label key="L_SAVE"}></span></a>
        </div>
        <div class="clearer"></div>
    </div>

    <form name="configuration-form" id="package-configuration-form" class="scope-main" action="<{$smarty.const.APPLICATION_URL}>/package/saveSettings" method="post" enctype="multipart/form-data">
