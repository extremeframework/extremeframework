...
<div class="edit_details">
    ...
    <div class="edit-buttons edit-buttons-top hidden-print">
        ...
        <{/foreach}>
        <a class="button-cancel scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/parameter/cancel/?back=0"><span class="button-face"><{_t('Cancel')}></span></a>
                        ...
                        <tbody>
                            <{foreach from=$columns item=column }>
                                ...
                                <{elseif $column == 'NAME' }>
                                    <tr class="form-row form-row-name <{if in_array($column, $mandatories) }>form-row-mandatory<{/if}>">
                                		<td>
                                		    <div class="form-field form-field-label">
                                		        <label><{_t('Parameter name')}><{if in_array('NAME', $mandatories) }><span class="mandatory">*</span><{/if}></label>
                                		    </div>
                                        </td>
                                        <td colspan="3">
                            ...
                            <input class="input-code" type="text" name="<{$prefix}>parameter_formdata_CODE" value="<{$tmp_value|escape}>" <{if !$row_edit}>size="40"<{/if}> />
                                ...
                                <{elseif $column == 'ID_PARAMETER_GROUP' }>
                                    <tr class="form-row form-row-id-parameter-group <{if in_array($column, $mandatories) }>form-row-mandatory<{/if}>">
                                		<td>
                                		    <div class="form-field form-field-label">
                                		        <label><{_t('Parameter group')}><{if in_array('ID_PARAMETER_GROUP', $mandatories) }><span class="mandatory">*</span><{/if}></label>
                                		    </div>
                                        </td>
                                        <td colspan="3">
                                ...
                                <{html_ref_select multilingual="1" autocomplete="1" ajax="0" method="" class="input-id-parameter-group" name="`$prefix`parameter_formdata_ID_PARAMETER_GROUP" value=$formdata.ID_PARAMETER_GROUP datasource="PARAMETER_GROUP" datasourcename="ParameterGroup" valuecol="ID" textcol="NAME" sortcol="NAME" groupcol="" blankitem=""}>
                                ...
                                <{elseif $column == 'ID_PARAMETER_TYPE' }>
                                    <tr class="form-row form-row-id-parameter-type <{if in_array($column, $mandatories) }>form-row-mandatory<{/if}>">
                                		<td>
                                		    <div class="form-field form-field-label">
                                		        <label><{_t('Parameter type')}><{if in_array('ID_PARAMETER_TYPE', $mandatories) }><span class="mandatory">*</span><{/if}></label>
                                		    </div>
                                        </td>
                                        <td colspan="3">
                                ...
                                <{html_ref_select multilingual="1" autocomplete="1" ajax="0" method="" class="input-id-parameter-type" name="`$prefix`parameter_formdata_ID_PARAMETER_TYPE" value=$formdata.ID_PARAMETER_TYPE datasource="PARAMETER_TYPE" datasourcename="ParameterType" valuecol="ID" textcol="NAME" sortcol="NAME" groupcol="" blankitem=""}>
                                ...
                                <{elseif $column == 'VALUE' }>
                                    <tr class="form-row form-row-value <{if in_array($column, $mandatories) }>form-row-mandatory<{/if}>">
                                		<td>
                                		    <div class="form-field form-field-label">
                                		        <label><{_t('Value')}><{if in_array('VALUE', $mandatories) }><span class="mandatory">*</span><{/if}></label>
                                		    </div>
                                        </td>
                                        <td colspan="3">
                            ...
                            <script type="text/javascript">htmlEditor('<{$prefix}>parameter_formdata_DESCRIPTION')</script>                                                                    </div>
                                        </td>
                                    </tr>
