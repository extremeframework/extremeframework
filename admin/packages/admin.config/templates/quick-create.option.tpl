<div class="modal-header">
    ...
    <h3><{label key="L_QUICK_CREATE" format="ucwords"}> <{$smarty.const.L_OPTION|ucwords}></h3>
</div>
...
<div id="option-edit" class="edit_details">
    ...
    <{if isset($messages.option) }>
        <ul class="message">
            <{foreach from=$messages.option key=field item=message}>
        ...
        <{else}>
    		<td class="form-row form-row-name form-row-mandatory">
                <div class="form-field form-field-label">
        		    <label><{label key="L_OPTION_NAME"}><span class="mandatory">*</span></label>
                </div>
            </td>
...
<{if !isset($excludedcolumns['CONTEXT'])}>
        ...
        <{else}>
    		<td class="form-row form-row-context">
                <div class="form-field form-field-label">
        		    <label><{label key="L_CONTEXT"}></label>
                </div>
            </td>
