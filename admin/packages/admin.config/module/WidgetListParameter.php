...
/**
 * Usage: <{module class="WidgetListParameter" method="<overriding_method>" COLUMN=? REFTABLE___REFCOLUMN=? where="<overriding_condition>" template='widgetlist.parameter.tpl'}>
 */
...
class WidgetListParameter extends ParameterController {
    function fetch($params) {
        ...
        if (AclController::hasPermission('parameter')) {
    		...
    		$smarty->assign('customfields', CustomFieldHelper::getListCustomFields('parameter', $preset, $presetvalue));
