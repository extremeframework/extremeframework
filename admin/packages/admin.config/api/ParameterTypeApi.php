...
class ParameterTypeApi extends ParameterTypeController
{
    var $module = 'parametertype';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('parametertype', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('parametertype', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('parametertype', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('parametertype', 'view');
