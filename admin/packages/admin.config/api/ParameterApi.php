...
class ParameterApi extends ParameterController
{
    var $module = 'parameter';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('parameter', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('parameter', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('parameter', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('parameter', 'view');
