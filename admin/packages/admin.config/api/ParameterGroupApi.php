...
class ParameterGroupApi extends ParameterGroupController
{
    var $module = 'parametergroup';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('parametergroup', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('parametergroup', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('parametergroup', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('parametergroup', 'view');
