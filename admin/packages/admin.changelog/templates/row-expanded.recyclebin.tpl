...
<tr class="embedded-view <{$type}>-embedded-view recyclebin-<{$type}>-embedded-view-<{$details->UUID}>" data-id="<{$details->UUID}>">
    <{if $smarty.request.source == 'list'}>
	    <td colspan="2"></td>
    	<td colspan="<{$smarty.request.colcount - 1}>">
            <div class="recyclebin-view view_details">
                <div class="section">
    	...
    	<td style="vertical-align: top;">
    	    <{if isset($smarty.session.acl.recyclebin.edit) && WorkflowHelper::isEditable($details->WFID) && !$readonly}>
