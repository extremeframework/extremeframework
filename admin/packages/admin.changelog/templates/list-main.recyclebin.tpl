...
<table class="item_list" id="recyclebinlist" data-module="recyclebin">
	...
	<tfoot>
            	...
            	<tr class="additem">
            	    <td colspan="2"></td>
            		<td colspan="<{$colcount}>">
                        <span style="cursor:pointer;text-decoration:underline;color:blue" class="recyclebin-rowedit-add"><{_t('L_ADD_ITEM')}></span>
                	    <span class="recyclebin-rowedit-buttons" style="display:none">
                    	    <div class="rowedit-save recyclebin-rowedit-save btn btn-success"><{_t('L_SAVE')}></div>
                    	    <a class="rowedit-cancel recyclebin-rowedit-cancel button-cancel"><{_t('L_CANCEL')}></a>
                        </span>
