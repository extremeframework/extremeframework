                    ...
                    <table class="table table-bordered table-custom-layout equal-split">
                        <tbody>
                            ...
                            <input class="input-item" type="text" name="<{$prefix}>recyclebin_formdata_ITEM" value="<{$tmp_value|escape}>" <{if !$row_edit}>size="40"<{/if}> />
                                ...
                                <{html_ref_select autocomplete="1" ajax="0" method="" class="input-id-user" name="`$prefix`recyclebin_formdata_ID_USER" value=$formdata.ID_USER datasource="USER" valuecol="ID" textcol="FIRST_NAME+LAST_NAME" sortcol="" groupcol="" blankitem=""}>
