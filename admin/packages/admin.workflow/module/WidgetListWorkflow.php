...
/**
 * Usage: <{module class="WidgetListWorkflow" method="<overriding_method>" COLUMN=? REFTABLE___REFCOLUMN=? where="<overriding_condition>" template='widgetlist.workflow.tpl'}>
 */
...
class WidgetListWorkflow extends WorkflowController {
    function fetch($params) {
        ...
        if (AclController::hasPermission('workflow')) {
    		...
    		$smarty->assign('customfields', CustomFieldHelper::getListCustomFields('workflow', $preset, $presetvalue));
