...
<table class="item_list" id="workflowlist" data-module="workflow">
        ...
        <{assign var='colcount' value=1}>
    	        ...
    	        <{if !isset($excludedcolumns['NAME']) && ((isset($aclviewablecolumns['NAME']) && $aclviewablecolumns['NAME']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['NAME']) || $aclviewablecolumns['NAME']))) }>
    	            <th class="column-name">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/workflow/sort/name"><{_t('L_WORKFLOW_NAME')}></a>
            ...
            <{/if}>
    	        ...
    	        <{if !isset($excludedcolumns['CODE']) && ((isset($aclviewablecolumns['CODE']) && $aclviewablecolumns['CODE']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['CODE']) || $aclviewablecolumns['CODE']))) }>
    	            <th class="column-code">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/workflow/sort/code"><{_t('L_CODE')}></a>
	...
	<tr class="top-holder" style="display:none">
	    <td colspan="<{$colcount+2}>" style="text-align:center;">
	    	<div class="selectall">All <{$rows|@count}> <{_t('L_WORKFLOW')|strtolower}>s on this page are selected. <a onclick="workflow_selectall()">Select all <{$total}> <{_t('L_WORKFLOW')|strtolower}>s in the list</a></div>
	    	<div class="clearselection">All <{$total}> <{_t('L_WORKFLOW')|strtolower}>s in the list are selected. <a onclick="workflow_clearselection()">Clear selection</a></div>
		</td>
	</tr>
	<{/if}>
	...
	<tfoot>
            	...
            	<tr class="additem">
            	    <td colspan="2"></td>
            		<td colspan="<{$colcount}>">
                        <span style="cursor:pointer;text-decoration:underline;color:blue" class="workflow-rowedit-add"><{_t('L_ADD_ITEM')}></span>
                	    <span class="workflow-rowedit-buttons" style="display:none">
                    	    <div class="rowedit-save workflow-rowedit-save btn btn-success"><{_t('L_SAVE')}></div>
                    	    <a class="rowedit-cancel workflow-rowedit-cancel button-cancel"><{_t('L_CANCEL')}></a>
                        </span>
