...
<table class="item_list" id="workflowstagelist" data-module="workflowstage">
            ...
            <{/if}>
    	        ...
    	        <{if !isset($excludedcolumns['NAME']) && ((isset($aclviewablecolumns['NAME']) && $aclviewablecolumns['NAME']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['NAME']) || $aclviewablecolumns['NAME']))) }>
    	            <th class="column-name">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/workflowstage/sort/name"><{_t('Workflow stage name')}></a>
	...
	<tfoot>
            	...
            	<tr class="additem">
            	    <td colspan="2"></td>
            		<td colspan="<{$colcount}>">
                        <span style="cursor:pointer;text-decoration:underline;color:blue" class="workflowstage-rowedit-add"><{_t('Add item')}></span>
                	    <span class="workflowstage-rowedit-buttons" style="display:none">
                    	    <div class="rowedit-save workflowstage-rowedit-save btn btn-success"><{_t('Save')}></div>
                    	    <a class="rowedit-cancel workflowstage-rowedit-cancel button-cancel"><{_t('Cancel')}></a>
                        </span>
