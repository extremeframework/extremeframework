...
<table class="item_list" id="workflowapplicationlist" data-module="workflowapplication">
	...
	<tfoot>
            	...
            	<tr class="additem">
            	    <td colspan="2"></td>
            		<td colspan="<{$colcount}>">
                        <span style="cursor:pointer;text-decoration:underline;color:blue" class="workflowapplication-rowedit-add"><{_t('Add item')}></span>
                	    <span class="workflowapplication-rowedit-buttons" style="display:none">
                    	    <div class="rowedit-save workflowapplication-rowedit-save btn btn-success"><{_t('Save')}></div>
                    	    <a class="rowedit-cancel workflowapplication-rowedit-cancel button-cancel"><{_t('Cancel')}></a>
                        </span>
