...
<{assign var='title' value=_t('Workflow Stage')}>
<{include file="top.tpl"}>

<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="workflowstagequicksearch" class="form-quicksearch scope-list" action="<{$smarty.const.APPLICATION_URL}>/workflowstage/search" method="get">
...
<{if isset($title) }>
    <h1 class="heading">
        ...
        <span style="margin-left:10px; font-size:12px; font-weight: normal" class="hidden-print">
            <a style="text-decoration: none" class="button-view-refresh scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/workflowstage"><i class="fa fa-refresh"></i></a>
        </span>
    </h1>
<{/if}>
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/workflowstage/new/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{_t('New', true)}> <{_t('Workflow Stage', true)|strtolower}>"/><{_t('New')}> <{_t('Workflow Stage')|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
...
<!-- Relations -->
    <{php}>
    	$template->assign('copyguidelines',  sprintf(_t('L_GUIDELINES_COPY_RELS', true), strtolower(_t('Workflow Stage', true))));
    	$template->assign('approveguidelines', sprintf(_t('L_GUIDELINES_APPROVE_RELS', true), strtolower(_t('Workflow Stage', true))));
    	$template->assign('deleteguidelines', sprintf(_t('L_GUIDELINES_DELETE_RELS', true), strtolower(_t('Workflow Stage', true)), strtolower(_t('Workflow Stage', true))));
    <{/php}>

    <div id="workflowstagecopyrelations" style="display:none" title="<{_t('Copy', true)}> <{_t('Workflow Stage', true)|strtolower}>">
        <p><{$copyguidelines}></p>
        <ul>
    ...
    <div id="workflowstageapproverelations" style="display:none" title="<{_t('Approve', true)}> <{_t('Workflow Stage', true)|strtolower}>">
    ...
    <div id="workflowstagedeleterelations" style="display:none" title="<{_t('Delete', true)}> <{_t('Workflow Stage', true)|strtolower}>">
