...
class WorkflowLogApi extends WorkflowLogController
{
    var $module = 'workflowlog';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('workflowlog', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('workflowlog', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('workflowlog', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('workflowlog', 'view');
