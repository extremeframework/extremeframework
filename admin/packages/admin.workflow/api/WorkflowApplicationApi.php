...
class WorkflowApplicationApi extends WorkflowApplicationController
{
    var $module = 'workflowapplication';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('workflowapplication', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('workflowapplication', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('workflowapplication', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('workflowapplication', 'view');
