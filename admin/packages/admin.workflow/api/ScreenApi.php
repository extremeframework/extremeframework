...
class ScreenApi extends ScreenController
{
    var $module = 'screen';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('screen', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('screen', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('screen', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('screen', 'view');
