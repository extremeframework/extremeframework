...
class ScreenFieldApi extends ScreenFieldController
{
    var $module = 'screenfield';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('screenfield', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('screenfield', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('screenfield', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('screenfield', 'view');
