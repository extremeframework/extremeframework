...
class WorkflowTransitionApi extends WorkflowTransitionController
{
    var $module = 'workflowtransition';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('workflowtransition', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('workflowtransition', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('workflowtransition', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('workflowtransition', 'view');
