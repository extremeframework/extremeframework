...
class CustomAccessRightApi extends CustomAccessRightController
{
    var $module = 'customaccessright';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('customaccessright', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('customaccessright', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('customaccessright', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('customaccessright', 'view');
