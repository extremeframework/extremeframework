...
class PermissionSetApi extends PermissionSetController
{
    var $module = 'permissionset';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('permissionset', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('permissionset', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('permissionset', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('permissionset', 'view');
