...
class PermissionSetItemApi extends PermissionSetItemController
{
    var $module = 'permissionsetitem';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('permissionsetitem', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('permissionsetitem', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('permissionsetitem', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('permissionsetitem', 'view');
