...
$(function() {
	...
	$('a.toggle').click(function(e) {
		...
		if (ison) {
			url = '<{$smarty.const.APPLICATION_URL}>/permissionsetitem/jsonRemovePermission/' + psid + '/' + module + '/' + action;
		} else {
			url = '<{$smarty.const.APPLICATION_URL}>/permissionsetitem/jsonAddPermission/' + psid + '/' + module + '/' + action;
		}
