...
<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="permissionsetquicksearch" class="form-quicksearch scope-main" action="<{$smarty.const.APPLICATION_URL}>/permissionset/search" method="get">
...
<{if isset($title) }>
    <h1 class="heading">
        ...
        <span style="margin-left:10px; font-size:12px; font-weight: normal" class="hidden-print">
            <a style="text-decoration: none" class="button-view-refresh scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/permissionset"><i class="fa fa-refresh"></i></a>
        </span>
    </h1>
<{/if}>
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/permissionset/new/<{if isset($preset) && isset($presetvalue)}>preset/<{$preset}>/presetvalue/<{$presetvalue}><{/if}><{if isset($presetstring)}>?<{$presetstring}><{/if}>"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{_t('New', true)}> <{_t('Permission Set', true)|strtolower}>"/><{_t('New')}> <{_t('Permission Set')|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
...
<!-- List -->
<form name="permissionsetlist" id="permissionsetlistform" class="form-list scope-main" action="<{$smarty.const.APPLICATION_URL}>/permissionset/" method="post">
...
<{if $pagination || $total > 10}>
	...
	<div style="clear:both"></div>
            ...
            <script type="text/javascript">
            $(function() {
            	bind_hotkey('#permissionsetlistform', 'left', '.pagination-prev');
            	bind_hotkey('#permissionsetlistform', 'right', '.pagination-next');
            });
        </script>
    <{else}>
	<br>
