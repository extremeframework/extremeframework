...
<{assign var='title' value=_t('Permission Set Item')}>
<{include file="top.tpl"}>

<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="permissionsetitemquicksearch" class="form-quicksearch scope-list" action="<{$smarty.const.APPLICATION_URL}>/permissionsetitem/search" method="get">
            ...
            <div class="buttons">
        	    ...
        	    <{/if}>
                            ...
                            <a href="#" onclick="permissionsetitem_delete()"><span class="button-face"><{_t('Delete')}></span></a>
                                            ...
                                            <{/if}>
                                                                                <{if isset($smarty.session.acl.permissionsetitem.import)}>
                                            <div class="btn button-general">
                            <a class="button-import scope-main" href="<{$smarty.const.APPLICATION_URL}>/permissionsetitem/import/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-import.png" alt="<{_t('Import', true)}>" /><{_t('Import')}></span></a>
                        </div>
                                            <{/if}>
                                                                                <{if isset($smarty.session.acl.permissionsetitem.export)}>
                                            <div class="btn button-general">
                            <a class="button-export" href="<{$smarty.const.APPLICATION_URL}>/permissionsetitem/export/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-export.png" alt="<{_t('Export', true)}>" /><{_t('Export')}></span></a>
                        </div>
                                            <{/if}>
...
<!-- List -->
<form name="permissionsetitemlist" id="permissionsetitemlistform" class="form-list scope-list" action="<{$smarty.const.APPLICATION_URL}>/permissionsetitem/" method="post">
