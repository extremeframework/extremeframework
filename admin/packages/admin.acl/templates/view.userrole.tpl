    ...
    <div class="view-buttons">
    	<{if $details->UUID}>
    	    ...
    	    <{/foreach}>
    	            ...
    	            <{if $admin_view_actions || $admin_view_options || isset($smarty.session.acl.userrole.customfields)}>
        	    <div class="button-general dropdown">
        	        ...
        	        <ul class="dropdown-menu pull-right">
                        ...
                        <{/foreach}>
                        <{if isset($smarty.session.acl.userrole.customfields)}>
                            <li><a class="scope-main" href="<{$smarty.const.APPLICATION_URL}>/customfield/manage/userrole"><{_t('Manage custom fields')}></a></li>
                        <{/if}>
                    </ul>
        	    </div>
            <{/if}>
