...
<{assign var='title' value=$smarty.const.L_USER_MEMBERSHIP}>
<{include file="top.tpl"}>

<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="usermembershipquicksearch" class="form-quicksearch scope-list" action="<{$smarty.const.APPLICATION_URL}>/usermembership/search" method="post" enctype="multipart/form-data">
