...
<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="userrolequicksearch" class="form-quicksearch scope-main" action="<{$smarty.const.APPLICATION_URL}>/userrole/search" method="post" enctype="multipart/form-data">
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main" href="<{$smarty.const.APPLICATION_URL}>/userrole/new/<{if isset($preset) && isset($presetvalue)}>preset/<{$preset}>/presetvalue/<{$presetvalue}><{/if}><{if isset($presetstring)}>?<{$presetstring}><{/if}>"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{$smarty.const.L_NEW}> <{$smarty.const.L_USER_ROLE|strtolower}>"/><{label key="L_NEW"}> <{$smarty.const.L_USER_ROLE|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
