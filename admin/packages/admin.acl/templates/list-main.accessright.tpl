...
<table class="item_list" id="accessrightlist" data-module="accessright">
        ...
        <{assign var='colcount' value=1}>
    	        ...
    	        <{if !isset($excludedcolumns['ID_USER_GROUP']) && ((isset($aclviewablecolumns['ID_USER_GROUP']) && $aclviewablecolumns['ID_USER_GROUP']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['ID_USER_GROUP']) || $aclviewablecolumns['ID_USER_GROUP']))) }>
    	            <th class="column-id-user-group">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/accessright/sort/id_user_group"><{label key="L_USER_GROUP"}></a>
            ...
            <{/if}>
    	        ...
    	        <{if !isset($excludedcolumns['MODULE']) && ((isset($aclviewablecolumns['MODULE']) && $aclviewablecolumns['MODULE']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['MODULE']) || $aclviewablecolumns['MODULE']))) }>
    	            <th class="column-module">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/accessright/sort/module"><{label key="L_MODULE"}></a>
            ...
            <{/if}>
    	        ...
    	        <{if !isset($excludedcolumns['ACTIONS']) && ((isset($aclviewablecolumns['ACTIONS']) && $aclviewablecolumns['ACTIONS']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['ACTIONS']) || $aclviewablecolumns['ACTIONS']))) }>
    	            <th class="column-actions">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/accessright/sort/actions"><{label key="L_ACTIONS"}></a>
	...
	<tr class="top-holder" style="display:none">
	    <td colspan="<{$colcount+2}>" style="text-align:center;">
	    	<div class="selectall">All <{$rows|@count}> <{$smarty.const.L_ACCESS_RIGHT|strtolower}>s on this page are selected. <a onclick="accessright_selectall()">Select all <{$total}> <{$smarty.const.L_ACCESS_RIGHT|strtolower}>s in the list</a></div>
	    	<div class="clearselection">All <{$total}> <{$smarty.const.L_ACCESS_RIGHT|strtolower}>s in the list are selected. <a onclick="accessright_clearselection()">Clear selection</a></div>
		</td>
	</tr>
	<{/if}>
	...
	<tfoot>
            	...
            	<tr class="additem">
            	    <td colspan="2"></td>
            		<td colspan="<{$colcount}>">
                        <span style="cursor:pointer;text-decoration:underline;color:blue" class="accessright-rowedit-add"><{label key="L_ADD_ITEM"}></span>
                	    <span class="accessright-rowedit-buttons" style="display:none">
                    	    <div class="rowedit-save accessright-rowedit-save btn btn-success"><{label key="L_SAVE"}></div>
                    	    <a class="rowedit-cancel accessright-rowedit-cancel button-cancel"><{label key="L_CANCEL"}></a>
                        </span>
