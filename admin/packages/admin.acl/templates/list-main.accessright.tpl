...
<table class="item_list" id="accessrightlist" data-module="accessright">
	...
	<tfoot>
            	...
            	<tr class="additem">
            	    <td colspan="2"></td>
            		<td colspan="<{$colcount}>">
                        <span style="cursor:pointer;text-decoration:underline;color:blue" class="accessright-rowedit-add"><{_t('L_ADD_ITEM')}></span>
                	    <span class="accessright-rowedit-buttons" style="display:none">
                    	    <div class="rowedit-save accessright-rowedit-save btn btn-success"><{_t('L_SAVE')}></div>
                    	    <a class="rowedit-cancel accessright-rowedit-cancel button-cancel"><{_t('L_CANCEL')}></a>
                        </span>
