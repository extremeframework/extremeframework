...
<{if !isset($excludedcolumns['MODULE'])}>
        ...
        <{else}>
            ...
            <{html_ref_select autocomplete="1" ajax="0" method="" id="input-module" class="input-module" name="`$prefix`objectacl_formdata_MODULE" value=$details->MODULE text=$details->reftext_MODULE datasource="ADMIN_MODULE" valuecol="MODULE" textcol="NAME" sortcol="" groupcol="" blankitem=""}>
...
<{if !isset($excludedcolumns['OBJECT_ID'])}>
        ...
        <{else}>
    		<td class="form-row form-row-object-id">
                <div class="form-field form-field-label">
        		    <label><{label key="L_OBJECT"}></label>
                </div>
            </td>
...
<{if !isset($excludedcolumns['ARG_ID_USER'])}>
        ...
        <{else}>
    		<td class="form-row form-row-arg-id-user">
                <div class="form-field form-field-label">
        		    <label><{label key="L_ARG_USER"}></label>
                </div>
            </td>
