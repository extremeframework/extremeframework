...
<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="fieldaclquicksearch" class="form-quicksearch scope-main" action="<{$smarty.const.APPLICATION_URL}>/fieldacl/search" method="get">
...
<{if isset($title) }>
    <h1 class="heading">
        ...
        <span style="margin-left:10px; font-size:12px; font-weight: normal" class="hidden-print">
            <a style="text-decoration: none" class="button-view-refresh scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/fieldacl"><i class="fa fa-refresh"></i></a>
        </span>
    </h1>
<{/if}>
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/fieldacl/new/<{if isset($preset) && isset($presetvalue)}>preset/<{$preset}>/presetvalue/<{$presetvalue}><{/if}><{if isset($presetstring)}>?<{$presetstring}><{/if}>"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{_t('L_NEW', true)}> <{_t('L_FIELD_ACL', true)|strtolower}>"/><{_t('L_NEW')}> <{_t('L_FIELD_ACL')|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
