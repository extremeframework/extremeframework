...
<{assign var='title' value=_t('L_OBJECT_ACL')}>
<{include file="top.tpl"}>

<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="objectaclquicksearch" class="form-quicksearch scope-list" action="<{$smarty.const.APPLICATION_URL}>/objectacl/search" method="get">
...
<{if isset($title) }>
    <h1 class="heading">
        ...
        <span style="margin-left:10px; font-size:12px; font-weight: normal" class="hidden-print">
            <a style="text-decoration: none" class="button-view-refresh scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/objectacl"><i class="fa fa-refresh"></i></a>
        </span>
    </h1>
<{/if}>
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/objectacl/new/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{_t('L_NEW', true)}> <{_t('L_OBJECT_ACL', true)|strtolower}>"/><{_t('L_NEW')}> <{_t('L_OBJECT_ACL')|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
...
<!-- List -->
<form name="objectacllist" id="objectacllistform" class="form-list scope-list" action="<{$smarty.const.APPLICATION_URL}>/objectacl/" method="post">
