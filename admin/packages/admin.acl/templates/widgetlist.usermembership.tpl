...
<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="usermembershipquicksearch" class="form-quicksearch scope-main" action="<{$smarty.const.APPLICATION_URL}>/usermembership/search" method="post" enctype="multipart/form-data">
            <input type="text" name="usermembership_searchdata___QUICKSEARCH__" value="<{if isset($searchdata.__QUICKSEARCH__)}><{$searchdata.__QUICKSEARCH__}><{/if}>" size="25" placeholder="<{_t('L_SEARCH', true)}>" />
...
<{if $pagination || $total > 10}>
	...
	<div style="float:left">
		<span class="usermembership-list-count list-count"><{$total}></span> <{_t('L_RECORDS')}>
	</div>
	<div style="clear:both"></div>
<{/if}>
