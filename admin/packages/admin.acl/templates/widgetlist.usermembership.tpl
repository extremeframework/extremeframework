...
<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="usermembershipquicksearch" class="form-quicksearch scope-main" action="<{$smarty.const.APPLICATION_URL}>/usermembership/search" method="get">
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/usermembership/new/<{if isset($preset) && isset($presetvalue)}>preset/<{$preset}>/presetvalue/<{$presetvalue}><{/if}><{if isset($presetstring)}>?<{$presetstring}><{/if}>"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{_t('L_NEW', true)}> <{_t('L_USER_MEMBERSHIP', true)|strtolower}>"/><{_t('L_NEW')}> <{_t('L_USER_MEMBERSHIP')|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
