...
<div class="view-control-bar hidden-print">
    ...
    <div class="view-buttons">
    	<{if $details->UUID}>
            ...
            <{/if}>
            <div class="button-general">
                <a class="button-close scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/acltype/close/?return=<{ContextStack::getRecentContext()}>"><span class="button-face"><{_t('Close')}></span></a>
            </div>
