...
<table class="item_list" id="acltypelist" data-module="acltype">
        ...
        <{assign var='colcount' value=1}>
    	        ...
    	        <{if !isset($excludedcolumns['NAME']) && ((isset($aclviewablecolumns['NAME']) && $aclviewablecolumns['NAME']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['NAME']) || $aclviewablecolumns['NAME']))) }>
    	            <th class="column-name">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/acltype/sort/name"><{label key="L_ACL_TYPE_NAME"}></a>
            ...
            <{/if}>
    	        ...
    	        <{if !isset($excludedcolumns['ORDERING']) && ((isset($aclviewablecolumns['ORDERING']) && $aclviewablecolumns['ORDERING']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['ORDERING']) || $aclviewablecolumns['ORDERING']))) }>
    	            <th class="column-ordering">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/acltype/sort/ordering"><{label key="L_ORDERING"}></a>
	...
	<tr class="top-holder" style="display:none">
	    <td colspan="<{$colcount+2}>" style="text-align:center;">
	    	<div class="selectall">All <{$rows|@count}> <{$smarty.const.L_ACL_TYPE|strtolower}>s on this page are selected. <a onclick="acltype_selectall()">Select all <{$total}> <{$smarty.const.L_ACL_TYPE|strtolower}>s in the list</a></div>
	    	<div class="clearselection">All <{$total}> <{$smarty.const.L_ACL_TYPE|strtolower}>s in the list are selected. <a onclick="acltype_clearselection()">Clear selection</a></div>
		</td>
	</tr>
	<{/if}>
	...
	<tfoot>
            	...
            	<tr class="additem">
            	    <td colspan="2"></td>
            		<td colspan="<{$colcount}>">
                        <span style="cursor:pointer;text-decoration:underline;color:blue" class="acltype-rowedit-add"><{label key="L_ADD_ITEM"}></span>
                	    <span class="acltype-rowedit-buttons" style="display:none">
                    	    <div class="rowedit-save acltype-rowedit-save btn btn-success"><{label key="L_SAVE"}></div>
                    	    <a class="rowedit-cancel acltype-rowedit-cancel button-cancel"><{label key="L_CANCEL"}></a>
                        </span>
