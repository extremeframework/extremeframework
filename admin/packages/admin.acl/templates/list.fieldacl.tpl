...
<{assign var='title' value=$smarty.const.L_FIELD_ACL}>
<{include file="top.tpl"}>

<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="fieldaclquicksearch" class="form-quicksearch scope-list" action="<{$smarty.const.APPLICATION_URL}>/fieldacl/search" method="post" enctype="multipart/form-data">
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main" href="<{$smarty.const.APPLICATION_URL}>/fieldacl/new/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{$smarty.const.L_NEW}> <{$smarty.const.L_FIELD_ACL|strtolower}>"/><{label key="L_NEW"}> <{$smarty.const.L_FIELD_ACL|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
