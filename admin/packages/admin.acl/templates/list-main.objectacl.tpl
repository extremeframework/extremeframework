...
<table class="item_list" id="objectacllist" data-module="objectacl">
	...
	<tfoot>
            	...
            	<tr class="additem">
            	    <td colspan="2"></td>
            		<td colspan="<{$colcount}>">
                        <span style="cursor:pointer;text-decoration:underline;color:blue" class="objectacl-rowedit-add"><{_t('Add item')}></span>
                	    <span class="objectacl-rowedit-buttons" style="display:none">
                    	    <div class="rowedit-save objectacl-rowedit-save btn btn-success"><{_t('Save')}></div>
                    	    <a class="rowedit-cancel objectacl-rowedit-cancel button-cancel"><{_t('Cancel')}></a>
                        </span>
