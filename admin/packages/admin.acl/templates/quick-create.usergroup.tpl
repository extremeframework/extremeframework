<div class="modal-header">
    ...
    <h3><{label key="L_QUICK_CREATE" format="ucwords"}> <{$smarty.const.L_USER_GROUP|ucwords}></h3>
</div>
...
<div id="usergroup-edit" class="edit_details">
    ...
    <{if isset($messages.usergroup) }>
        <ul class="message">
            <{foreach from=$messages.usergroup key=field item=message}>
        ...
        <{else}>
    		<td class="form-row form-row-name form-row-mandatory">
                <div class="form-field form-field-label">
        		    <label><{label key="L_USER_GROUP_NAME"}><span class="mandatory">*</span></label>
                </div>
            </td>
...
<{if !isset($excludedcolumns['DEFAULT_ID_DASHBOARD'])}>
        ...
        <{else}>
    		<td class="form-row form-row-default-id-dashboard">
                <div class="form-field form-field-label">
        		    <label><{label key="L_DEFAULT_DASHBOARD"}></label>
                </div>
            </td>
