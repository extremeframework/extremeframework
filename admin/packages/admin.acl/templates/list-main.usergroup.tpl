...
<table class="item_list" id="usergrouplist" data-module="usergroup">
        ...
        <{assign var='colcount' value=1}>
    	        ...
    	        <{if !isset($excludedcolumns['NAME']) && ((isset($aclviewablecolumns['NAME']) && $aclviewablecolumns['NAME']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['NAME']) || $aclviewablecolumns['NAME']))) }>
    	            <th class="column-name">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/usergroup/sort/name"><{_t('User group name')}></a>
	...
	<tfoot>
            	...
            	<tr class="additem">
            	    <td colspan="2"></td>
            		<td colspan="<{$colcount}>">
                        <span style="cursor:pointer;text-decoration:underline;color:blue" class="usergroup-rowedit-add"><{_t('Add item')}></span>
                	    <span class="usergroup-rowedit-buttons" style="display:none">
                    	    <div class="rowedit-save usergroup-rowedit-save btn btn-success"><{_t('Save')}></div>
                    	    <a class="rowedit-cancel usergroup-rowedit-cancel button-cancel"><{_t('Cancel')}></a>
                        </span>
