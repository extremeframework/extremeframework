...
<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="accessrightquicksearch" class="form-quicksearch scope-list" action="<{$smarty.const.APPLICATION_URL}>/accessright/search" method="get">
            <input type="text" name="accessright_searchdata___QUICKSEARCH__" value="<{if isset($searchdata.__QUICKSEARCH__)}><{$searchdata.__QUICKSEARCH__}><{/if}>" size="25" placeholder="<{_t('L_SEARCH', true)}>" />
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/accessright/new/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{_t('L_NEW', true)}> <{_t('L_ACCESS_RIGHT', true)|strtolower}>"/><{_t('L_NEW')}> <{_t('L_ACCESS_RIGHT')|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
