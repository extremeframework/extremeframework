...
class AclTypeApi extends AclTypeController
{
    var $module = 'acltype';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('acltype', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('acltype', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('acltype', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('acltype', 'view');
