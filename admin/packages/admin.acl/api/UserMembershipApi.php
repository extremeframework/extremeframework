...
class UserMembershipApi extends UserMembershipController
{
    var $module = 'usermembership';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('usermembership', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('usermembership', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('usermembership', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('usermembership', 'view');
