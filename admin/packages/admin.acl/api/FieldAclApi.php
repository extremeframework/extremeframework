...
class FieldAclApi extends FieldAclController
{
    var $module = 'fieldacl';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('fieldacl', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('fieldacl', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('fieldacl', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('fieldacl', 'view');
