...
class UserGroupApi extends UserGroupController
{
    var $module = 'usergroup';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('usergroup', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('usergroup', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('usergroup', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('usergroup', 'view');
