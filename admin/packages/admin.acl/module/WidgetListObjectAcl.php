...
/**
 * Usage: <{module class="WidgetListObjectAcl" method="<overriding_method>" COLUMN=? REFTABLE___REFCOLUMN=? where="<overriding_condition>" template='widgetlist.objectacl.tpl'}>
 */
...
class WidgetListObjectAcl extends ObjectAclController {
    function fetch($params) {
        ...
        if (AclController::hasPermission('objectacl')) {
    		...
    		$smarty->assign('customfields', CustomFieldHelper::getListCustomFields('objectacl', $preset, $presetvalue));
