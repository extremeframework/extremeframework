...
<table class="item_list" id="userloglist" data-module="userlog">
	...
	<tfoot>
            	...
            	<tr class="additem">
            	    <td colspan="2"></td>
            		<td colspan="<{$colcount}>">
                        <span style="cursor:pointer;text-decoration:underline;color:blue" class="userlog-rowedit-add"><{_t('Add item')}></span>
                	    <span class="userlog-rowedit-buttons" style="display:none">
                    	    <div class="rowedit-save userlog-rowedit-save btn btn-success"><{_t('Save')}></div>
                    	    <a class="rowedit-cancel userlog-rowedit-cancel button-cancel"><{_t('Cancel')}></a>
                        </span>
