...
<table class="item_list" id="userlist" data-module="user">
	...
	<tfoot>
            	...
            	<tr class="additem">
            	    <td colspan="2"></td>
            		<td colspan="<{$colcount}>">
                        <span style="cursor:pointer;text-decoration:underline;color:blue" class="user-rowedit-add"><{_t('L_ADD_ITEM')}></span>
                	    <span class="user-rowedit-buttons" style="display:none">
                    	    <div class="rowedit-save user-rowedit-save btn btn-success"><{_t('L_SAVE')}></div>
                    	    <a class="rowedit-cancel user-rowedit-cancel button-cancel"><{_t('L_CANCEL')}></a>
                        </span>
