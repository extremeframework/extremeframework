...
<{assign var='title' value=_t('User Log')}>
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/userlog/new/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{_t('New', true)}> <{_t('User Log', true)|strtolower}>"/><{_t('New')}> <{_t('User Log')|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
