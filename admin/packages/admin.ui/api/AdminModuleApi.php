...
class AdminModuleApi extends AdminModuleController
{
    var $module = 'adminmodule';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('adminmodule', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('adminmodule', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('adminmodule', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('adminmodule', 'view');
