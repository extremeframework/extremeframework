...
class UserPreferenceApi extends UserPreferenceController
{
    var $module = 'userpreference';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('userpreference', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('userpreference', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('userpreference', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('userpreference', 'view');
