...
class AdminMenuApi extends AdminMenuController
{
    var $module = 'adminmenu';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('adminmenu', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('adminmenu', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('adminmenu', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('adminmenu', 'view');
