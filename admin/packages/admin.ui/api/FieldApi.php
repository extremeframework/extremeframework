...
class FieldApi extends FieldController
{
    var $module = 'field';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('field', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('field', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('field', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('field', 'view');
