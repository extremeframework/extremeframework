...
class AdminMenuItemApi extends AdminMenuItemController
{
    var $module = 'adminmenuitem';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('adminmenuitem', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('adminmenuitem', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('adminmenuitem', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('adminmenuitem', 'view');
