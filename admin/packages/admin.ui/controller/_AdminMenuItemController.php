...
class _AdminMenuItemController extends __AppController
{
    ...
    public function delete($target_column, $target_values, &$_ids = null) {
        ...
        NotificationHelper::notifyChange('adminmenuitem', 'delete');
    }
    ...
    protected function save($models = array(), $refobject = null) {
        ...
        foreach ($models as $model) {
    		...
    		if ($model->UUID) {
                ...
                NotificationHelper::notifyChange('adminmenuitem', 'update');
            } else {
                $model->ID = null;
    		    ...
    		    NotificationHelper::notifyChange('adminmenuitem', 'insert');
            }
