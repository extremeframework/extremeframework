...
class _DashboardController extends __AppController
{
    ...
    protected function form2model($prefix = null, &$columns2check = null) {
        ...
        $columns2edit = array('UUID', 'NAME', 'ID_ADMIN_MENU', 'ID_DASHBOARD_LAYOUT', 'DASHBOARD_FILE_PATH');
    ...
    protected function getCustomFilterColumns($module, &$filter = null) {
        if (!Framework::hasModule('AdminFilter')) {
            return array('NAME', 'ID_ADMIN_MENU', 'ID_DASHBOARD_LAYOUT', 'DASHBOARD_FILE_PATH');
        }
    ...
    protected function _edit($id, $details = null, $templatecode = 'edit.dashboard.tpl', $restoredraft = true) {
        ...
        $roweditablecolumns = array('NAME', 'ID_ADMIN_MENU', 'ID_DASHBOARD_LAYOUT', 'DASHBOARD_FILE_PATH');
        ...
        foreach($filters as $key => $value) {
            ...
            if ($value != '') {
                switch ($key) {
                    ...
                    case 'ID_DASHBOARD_LAYOUT':
                        if ($value == '__NULL__') {
                            $model->whereAdd(TABLE_PREFIX."DASHBOARD.ID_DASHBOARD_LAYOUT IS NULL");
                        } else {
                            $model->whereAdd(TABLE_PREFIX."DASHBOARD.ID_DASHBOARD_LAYOUT = '$value'");
                        }
    ...
    protected function setupQuickSearchModel(&$model, $searchstring) {
        ...
        foreach ($keywords as $keyword) {
            ...
            $conds[] = TABLE_PREFIX."DASHBOARD.DASHBOARD_FILE_PATH LIKE '%".$model->escape(StringHelper::htmlspecialchars($keyword))."%'";
