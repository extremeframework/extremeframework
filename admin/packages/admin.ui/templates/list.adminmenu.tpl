...
<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="adminmenuquicksearch" class="form-quicksearch scope-list" action="<{$smarty.const.APPLICATION_URL}>/adminmenu/search" method="get">
            <input type="text" name="adminmenu_searchdata___QUICKSEARCH__" value="<{if isset($searchdata.__QUICKSEARCH__)}><{$searchdata.__QUICKSEARCH__}><{/if}>" size="25" placeholder="<{_t('L_SEARCH', true)}>" />
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/adminmenu/new/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{_t('L_NEW', true)}> <{_t('L_ADMIN_MENU', true)|strtolower}>"/><{_t('L_NEW')}> <{_t('L_ADMIN_MENU')|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
...
<!-- Relations -->
    ...
    <div id="adminmenucopyrelations" style="display:none" title="<{_t('L_COPY', true)}> <{_t('L_ADMIN_MENU', true)|strtolower}>">
        <p><{$copyguidelines}></p>
        <ul>
                ...
                <{/if}>
                    ...
                    <li style="padding:5px 0 5px 0"><input type="checkbox" name="copyrelations[]" value="dashboard" /> <{_t('L_COPY_ALSO')}> <{_t('L_DASHBOARD')|strtolower}></li>
                <{/if}>
                    </ul>
    </div>

    <div id="adminmenuapproverelations" style="display:none" title="<{_t('L_APPROVE', true)}> <{_t('L_ADMIN_MENU', true)|strtolower}>">
        ...
        <ul>
                ...
                <{/if}>
                            <{if Framework::hasModule('Dashboard')}>
                    <li style="padding:5px 0 5px 0"><input type="checkbox" name="approverelations[]" value="dashboard" /> <{_t('L_APPROVE_ALSO')}> <{_t('L_DASHBOARD')|strtolower}></li>
                <{/if}>
                    </ul>
    </div>

    <div id="adminmenudeleterelations" style="display:none" title="<{_t('L_DELETE', true)}> <{_t('L_ADMIN_MENU', true)|strtolower}>">
        ...
        <ul>
                ...
                <{/if}>
                            <{if Framework::hasModule('Dashboard')}>
                    <li style="padding:5px 0 5px 0"><input type="checkbox" name="deleterelations[]" value="dashboard" /> <{_t('L_DELETE_ALSO')}> <{_t('L_DASHBOARD')|strtolower}></li>
                <{/if}>
                    </ul>
    </div>
...
<{if $pagination || $total > 10}>
	...
	<div style="float:left">
		<span class="adminmenu-list-count list-count"><{$total}></span> <{_t('L_RECORDS')}>
	</div>
	<div style="clear:both"></div>
<{/if}>
