<div class="modal-header">
    ...
    <h3><{label key="L_QUICK_CREATE" format="ucwords"}> <{$smarty.const.L_FIELD|ucwords}></h3>
</div>
...
<div id="field-edit" class="edit_details">
    ...
    <{if isset($messages.field) }>
        <ul class="message">
            <{foreach from=$messages.field key=field item=message}>
        ...
        <{else}>
    		<td class="form-row form-row-name form-row-mandatory">
                <div class="form-field form-field-label">
        		    <label><{label key="L_FIELD_NAME"}><span class="mandatory">*</span></label>
                </div>
            </td>
...
<{if !isset($excludedcolumns['MODULE'])}>
        ...
        <{else}>
            ...
            <{html_ref_select autocomplete="1" ajax="0" method="" id="input-module" class="input-module" name="`$prefix`field_formdata_MODULE" value=$details->MODULE text=$details->reftext_MODULE datasource="ADMIN_MODULE" valuecol="MODULE" textcol="NAME" sortcol="" groupcol="" blankitem=""}>
...
<{if !isset($excludedcolumns['TOOLTIP'])}>
        ...
        <{else}>
    		<td class="form-row form-row-tooltip">
                <div class="form-field form-field-label">
        		    <label><{label key="L_TOOLTIP"}></label>
                </div>
            </td>
...
<{if !isset($excludedcolumns['IS_EXCLUDED'])}>
        ...
        <{else}>
    		<td class="form-row form-row-is-excluded">
                <div class="form-field form-field-label">
        		    <label><{label key="L_IS_EXCLUDED"}></label>
                </div>
            </td>
