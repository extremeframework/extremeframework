...
<table class="item_list" id="fieldlist" data-module="field">
        ...
        <{assign var='colcount' value=1}>
    	        ...
    	        <{if !isset($excludedcolumns['NAME']) && ((isset($aclviewablecolumns['NAME']) && $aclviewablecolumns['NAME']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['NAME']) || $aclviewablecolumns['NAME']))) }>
    	            <th class="column-name">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/field/sort/name"><{label key="L_FIELD_NAME"}></a>
            ...
            <{/if}>
    	        ...
    	        <{if !isset($excludedcolumns['MODULE']) && ((isset($aclviewablecolumns['MODULE']) && $aclviewablecolumns['MODULE']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['MODULE']) || $aclviewablecolumns['MODULE']))) }>
    	            <th class="column-module">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/field/sort/module"><{label key="L_MODULE"}></a>
            ...
            <{/if}>
    	        ...
    	        <{if !isset($excludedcolumns['COLUMN']) && ((isset($aclviewablecolumns['COLUMN']) && $aclviewablecolumns['COLUMN']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['COLUMN']) || $aclviewablecolumns['COLUMN']))) }>
    	            <th class="column-column">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/field/sort/column"><{label key="L_COLUMN"}></a>
            ...
            <{/if}>
    	        ...
    	        <{if !isset($excludedcolumns['TOOLTIP']) && ((isset($aclviewablecolumns['TOOLTIP']) && $aclviewablecolumns['TOOLTIP']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['TOOLTIP']) || $aclviewablecolumns['TOOLTIP']))) }>
    	            <th class="column-tooltip">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/field/sort/tooltip"><{label key="L_TOOLTIP"}></a>
            ...
            <{/if}>
    	        ...
    	        <{if !isset($excludedcolumns['IS_EXCLUDED']) && ((isset($aclviewablecolumns['IS_EXCLUDED']) && $aclviewablecolumns['IS_EXCLUDED']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['IS_EXCLUDED']) || $aclviewablecolumns['IS_EXCLUDED']))) }>
    	            <th class="column-is-excluded">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/field/sort/is_excluded"><{label key="L_IS_EXCLUDED"}></a>
	...
	<tr class="top-holder" style="display:none">
	    <td colspan="<{$colcount+2}>" style="text-align:center;">
	    	<div class="selectall">All <{$rows|@count}> <{$smarty.const.L_FIELD|strtolower}>s on this page are selected. <a onclick="field_selectall()">Select all <{$total}> <{$smarty.const.L_FIELD|strtolower}>s in the list</a></div>
	    	<div class="clearselection">All <{$total}> <{$smarty.const.L_FIELD|strtolower}>s in the list are selected. <a onclick="field_clearselection()">Clear selection</a></div>
		</td>
	</tr>
	<{/if}>
	...
	<tfoot>
            	...
            	<tr class="additem">
            	    <td colspan="2"></td>
            		<td colspan="<{$colcount}>">
                        <span style="cursor:pointer;text-decoration:underline;color:blue" class="field-rowedit-add"><{label key="L_ADD_ITEM"}></span>
                	    <span class="field-rowedit-buttons" style="display:none">
                    	    <div class="rowedit-save field-rowedit-save btn btn-success"><{label key="L_SAVE"}></div>
                    	    <a class="rowedit-cancel field-rowedit-cancel button-cancel"><{label key="L_CANCEL"}></a>
                        </span>
