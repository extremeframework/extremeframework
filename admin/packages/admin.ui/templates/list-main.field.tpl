...
<table class="item_list" id="fieldlist" data-module="field">
	...
	<tfoot>
            	...
            	<tr class="additem">
            	    <td colspan="2"></td>
            		<td colspan="<{$colcount}>">
                        <span style="cursor:pointer;text-decoration:underline;color:blue" class="field-rowedit-add"><{_t('L_ADD_ITEM')}></span>
                	    <span class="field-rowedit-buttons" style="display:none">
                    	    <div class="rowedit-save field-rowedit-save btn btn-success"><{_t('L_SAVE')}></div>
                    	    <a class="rowedit-cancel field-rowedit-cancel button-cancel"><{_t('L_CANCEL')}></a>
                        </span>
