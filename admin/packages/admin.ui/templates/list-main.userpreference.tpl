...
<table class="item_list" id="userpreferencelist" data-module="userpreference">
	...
	<tfoot>
            	...
            	<tr class="additem">
            	    <td colspan="2"></td>
            		<td colspan="<{$colcount}>">
                        <span style="cursor:pointer;text-decoration:underline;color:blue" class="userpreference-rowedit-add"><{_t('Add item')}></span>
                	    <span class="userpreference-rowedit-buttons" style="display:none">
                    	    <div class="rowedit-save userpreference-rowedit-save btn btn-success"><{_t('Save')}></div>
                    	    <a class="rowedit-cancel userpreference-rowedit-cancel button-cancel"><{_t('Cancel')}></a>
                        </span>
