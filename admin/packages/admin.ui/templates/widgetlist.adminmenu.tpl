...
<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="adminmenuquicksearch" class="form-quicksearch scope-main" action="<{$smarty.const.APPLICATION_URL}>/adminmenu/search" method="post" enctype="multipart/form-data">
