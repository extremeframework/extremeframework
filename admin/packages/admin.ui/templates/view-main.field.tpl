<div class="view-main">
    <{plugin key="field_view_top" args=$details}>
        ...
        <{if !isset($columns2hide) || !in_array('NAME', $columns2hide) }>
    		<td class="form-field form-field-label column-name">
	            		        <label class="attribute-name"><{_t('Field name')}></label>
            </td>
    ...
    <{/if}>
            ...
            <{html_ref_select multilingual="0" autocomplete="1" ajax="0" method="" id="input-module" class="input-module" name="`$prefix`field_formdata_MODULE" value=$details->MODULE text=$details->reftext_MODULE datasource="ADMIN_MODULE" datasourcename="AdminModule" valuecol="MODULE" textcol="NAME" sortcol="NAME"}>
	...
	<{/if}>
        ...
        <{if !isset($columns2hide) || !in_array('TOOLTIP', $columns2hide) }>
    		<td class="form-field form-field-label column-tooltip">
	            		        <label class="attribute-name"><{_t('Tooltip')}></label>
            </td>
	...
	<{/if}>
        ...
        <{if !isset($columns2hide) || !in_array('IS_EXCLUDED', $columns2hide) }>
    		<td class="form-field form-field-label column-is-excluded">
	            		        <label class="attribute-name"><{_t('Excluded?')}></label>
            </td>
    ...
    <{if $details->IS_EXCLUDED}><{_t('Yes')}><{else}><{_t('No')}><{/if}>
                                </span>
                                <!--
                    		    <span class="edit-mode" style="display:none">
