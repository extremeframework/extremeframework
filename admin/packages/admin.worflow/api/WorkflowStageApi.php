...
class WorkflowStageApi extends WorkflowStageController
{
    var $module = 'workflowstage';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('workflowstage', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('workflowstage', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('workflowstage', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('workflowstage', 'view');
