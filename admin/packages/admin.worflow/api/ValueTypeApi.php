...
class ValueTypeApi extends ValueTypeController
{
    var $module = 'valuetype';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('valuetype', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('valuetype', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('valuetype', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('valuetype', 'view');
