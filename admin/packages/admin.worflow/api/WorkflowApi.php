...
class WorkflowApi extends WorkflowController
{
    var $module = 'workflow';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('workflow', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('workflow', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('workflow', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('workflow', 'view');
