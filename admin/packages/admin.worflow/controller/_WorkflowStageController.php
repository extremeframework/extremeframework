...
class _WorkflowStageController extends __AppController
{
    ...
    public function delete($target_column, $target_values, &$_ids = null) {
        ...
        NotificationHelper::notifyChange('workflowstage', 'delete');
    }
    ...
    protected function save($models = array(), $refobject = null) {
        ...
        foreach ($models as $model) {
    		...
    		if ($model->UUID) {
                ...
                NotificationHelper::notifyChange('workflowstage', 'update');
            } else {
                $model->ID = null;
    		    ...
    		    NotificationHelper::notifyChange('workflowstage', 'insert');
            }
