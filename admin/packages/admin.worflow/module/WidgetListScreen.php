...
/**
 * Usage: <{module class="WidgetListScreen" method="<overriding_method>" COLUMN=? REFTABLE___REFCOLUMN=? where="<overriding_condition>" template='widgetlist.screen.tpl'}>
 */
...
class WidgetListScreen extends ScreenController {
    function fetch($params, $smarty) {
        ...
        if (AclController::hasPermission('screen')) {
    		...
    		$smarty->assign('customfields', CustomFieldHelper::getListCustomFields('screen', $preset, $presetvalue));
