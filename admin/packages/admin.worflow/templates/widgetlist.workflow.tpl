...
<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="workflowquicksearch" class="form-quicksearch scope-main" action="<{$smarty.const.APPLICATION_URL}>/workflow/search" method="post" enctype="multipart/form-data">
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main" href="<{$smarty.const.APPLICATION_URL}>/workflow/new/<{if isset($preset) && isset($presetvalue)}>preset/<{$preset}>/presetvalue/<{$presetvalue}><{/if}><{if isset($presetstring)}>?<{$presetstring}><{/if}>"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{_t('L_NEW', true)}> <{_t('L_WORKFLOW', true)|strtolower}>"/><{_t('L_NEW')}> <{_t('L_WORKFLOW')|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
