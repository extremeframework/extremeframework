<div class="modal-header">
    ...
    <h3><{label key="L_QUICK_CREATE" format="ucwords"}> <{$smarty.const.L_VALUE_TYPE|ucwords}></h3>
</div>
...
<div id="valuetype-edit" class="edit_details">
    ...
    <{if isset($messages.valuetype) }>
        <ul class="message">
            <{foreach from=$messages.valuetype key=field item=message}>
        ...
        <{else}>
    		<td class="form-row form-row-name form-row-mandatory">
                <div class="form-field form-field-label">
        		    <label><{label key="L_VALUE_TYPE_NAME"}><span class="mandatory">*</span></label>
                </div>
            </td>
