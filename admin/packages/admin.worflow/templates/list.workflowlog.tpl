...
<{assign var='title' value=$smarty.const.L_WORKFLOW_LOG}>
<{include file="top.tpl"}>

<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="workflowlogquicksearch" class="form-quicksearch scope-list" action="<{$smarty.const.APPLICATION_URL}>/workflowlog/search" method="post" enctype="multipart/form-data">
