...
<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="workflowquicksearch" class="form-quicksearch scope-list" action="<{$smarty.const.APPLICATION_URL}>/workflow/search" method="post" enctype="multipart/form-data">
            <input type="text" name="workflow_searchdata___QUICKSEARCH__" value="<{if isset($searchdata.__QUICKSEARCH__)}><{$searchdata.__QUICKSEARCH__}><{/if}>" size="25" placeholder="<{_t('L_SEARCH')}>" />
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main" href="<{$smarty.const.APPLICATION_URL}>/workflow/new/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{_t('L_NEW')}> <{_t('L_WORKFLOW')|strtolower}>"/><{_t('L_NEW')}> <{_t('L_WORKFLOW')|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
...
<!-- Relations -->
    ...
    <div id="workflowcopyrelations" style="display:none" title="<{_t('L_COPY')}> <{_t('L_WORKFLOW')|strtolower}>">
        <p><{$copyguidelines}></p>
        <ul>
    ...
    <div id="workflowapproverelations" style="display:none" title="<{_t('L_APPROVE')}> <{_t('L_WORKFLOW')|strtolower}>">
    ...
    <div id="workflowdeleterelations" style="display:none" title="<{_t('L_DELETE')}> <{_t('L_WORKFLOW')|strtolower}>">
