...
<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="workflowapplicationquicksearch" class="form-quicksearch scope-main" action="<{$smarty.const.APPLICATION_URL}>/workflowapplication/search" method="post" enctype="multipart/form-data">
            <input type="text" name="workflowapplication_searchdata___QUICKSEARCH__" value="<{if isset($searchdata.__QUICKSEARCH__)}><{$searchdata.__QUICKSEARCH__}><{/if}>" size="25" placeholder="<{_t('L_SEARCH')}>" />
