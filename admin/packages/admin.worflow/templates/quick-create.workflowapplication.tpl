<div class="modal-header">
    ...
    <h3><{label key="L_QUICK_CREATE" format="ucwords"}> <{$smarty.const.L_WORKFLOW_APPLICATION|ucwords}></h3>
</div>
...
<div id="workflowapplication-edit" class="edit_details">
    ...
    <{if isset($messages.workflowapplication) }>
        <ul class="message">
            <{foreach from=$messages.workflowapplication key=field item=message}>
