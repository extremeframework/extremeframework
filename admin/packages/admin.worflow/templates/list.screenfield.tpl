...
<{assign var='title' value=_t('L_SCREEN_FIELD')}>
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main" href="<{$smarty.const.APPLICATION_URL}>/screenfield/new/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{_t('L_NEW')}> <{_t('L_SCREEN_FIELD')|strtolower}>"/><{_t('L_NEW')}> <{_t('L_SCREEN_FIELD')|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
