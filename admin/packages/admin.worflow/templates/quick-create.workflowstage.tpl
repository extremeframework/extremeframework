<div class="modal-header">
    ...
    <h3><{label key="L_QUICK_CREATE" format="ucwords"}> <{$smarty.const.L_WORKFLOW_STAGE|ucwords}></h3>
</div>
...
<div id="workflowstage-edit" class="edit_details">
    ...
    <{if isset($messages.workflowstage) }>
        <ul class="message">
            <{foreach from=$messages.workflowstage key=field item=message}>
        ...
        workflowstage_update_visibility_settings();
            ...
            <button class="btn btn-success" type="submit" onclick="$('#pageform').submit()">
                <strong><{label key="L_SAVE"}></strong>
                            ...
                            <a class="btn btn-full-form scope-main" href="<{$smarty.const.APPLICATION_URL}>/workflowstage/new">
