...
<tr class="embedded-view <{$type}>-embedded-view workflow-<{$type}>-embedded-view-<{$details->UUID}>" data-id="<{$details->UUID}>">
    <{if $smarty.request.source == 'list'}>
	    <td colspan="2"></td>
    	<td colspan="<{$smarty.request.colcount - 1}>">
            <div class="workflow-view view_details">
                <div class="section">
    	...
    	<td style="vertical-align: top;">
    	    <{if isset($smarty.session.acl.workflow.edit) && WorkflowHelper::isEditable($details->WFID) && !$readonly}>
