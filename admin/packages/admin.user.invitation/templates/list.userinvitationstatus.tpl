...
<{assign var='title' value=_t('User Invitation Status')}>
<{include file="top.tpl"}>

<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="userinvitationstatusquicksearch" class="form-quicksearch scope-list" action="<{$smarty.const.APPLICATION_URL}>/userinvitationstatus/search" method="get">
...
<{if isset($title) }>
    <h1 class="heading">
        ...
        <span style="margin-left:10px; font-size:12px; font-weight: normal" class="hidden-print">
            <a style="text-decoration: none" class="button-view-refresh scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/userinvitationstatus"><i class="fa fa-refresh"></i></a>
        </span>
    </h1>
<{/if}>
            ...
            <div class="buttons">
        	    ...
        	    <{/if}>
                            ...
                            <a href="#" onclick="userinvitationstatus_delete()"><span class="button-face"><{_t('Delete')}></span></a>
                                            ...
                                            <{/if}>
                                                                                <{if isset($smarty.session.acl.userinvitationstatus.import)}>
                                            <div class="btn button-general">
                            <a class="button-import scope-main" href="<{$smarty.const.APPLICATION_URL}>/userinvitationstatus/import/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-import.png" alt="<{_t('Import', true)}>" /><{_t('Import')}></span></a>
                        </div>
                                            <{/if}>
                                                                                <{if isset($smarty.session.acl.userinvitationstatus.export)}>
                                            <div class="btn button-general">
                            <a class="button-export" href="<{$smarty.const.APPLICATION_URL}>/userinvitationstatus/export/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-export.png" alt="<{_t('Export', true)}>" /><{_t('Export')}></span></a>
                        </div>
                                            <{/if}>
...
<!-- Relations -->
    <{php}>
    	$template->assign('copyguidelines',  sprintf(_t('L_GUIDELINES_COPY_RELS', true), strtolower(_t('User Invitation Status', true))));
    	$template->assign('approveguidelines', sprintf(_t('L_GUIDELINES_APPROVE_RELS', true), strtolower(_t('User Invitation Status', true))));
    	$template->assign('deleteguidelines', sprintf(_t('L_GUIDELINES_DELETE_RELS', true), strtolower(_t('User Invitation Status', true)), strtolower(_t('User Invitation Status', true))));
    <{/php}>

    <div id="userinvitationstatuscopyrelations" style="display:none" title="<{_t('Copy', true)}> <{_t('User Invitation Status', true)|strtolower}>">
        <p><{$copyguidelines}></p>
        <ul>
    ...
    <div id="userinvitationstatusapproverelations" style="display:none" title="<{_t('Approve', true)}> <{_t('User Invitation Status', true)|strtolower}>">
    ...
    <div id="userinvitationstatusdeleterelations" style="display:none" title="<{_t('Delete', true)}> <{_t('User Invitation Status', true)|strtolower}>">
...
<!-- List -->
<form name="userinvitationstatuslist" id="userinvitationstatuslistform" class="form-list scope-list" action="<{$smarty.const.APPLICATION_URL}>/userinvitationstatus/" method="post">
...
function userinvitationstatus_delete() {
	var dialog = $( "#userinvitationstatusdeleterelations" ).dialog({
		resizable: true,
		width: 500,
		modal: false,
		buttons: {
	...
	dialog.parent().appendTo($('#userinvitationstatuslistform'));
}

function userinvitationstatus_copy() {
	var dialog = $( "#userinvitationstatuscopyrelations" ).dialog({
		resizable: true,
		width: 500,
		modal: false,
		buttons: {
...
function userinvitationstatus_approve() {
	var dialog = $( "#userinvitationstatusapproverelations" ).dialog({
		resizable: true,
		width: 500,
		modal: false,
		buttons: {
