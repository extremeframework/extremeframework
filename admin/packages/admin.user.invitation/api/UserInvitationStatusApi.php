...
class UserInvitationStatusApi extends UserInvitationStatusController
{
    var $module = 'userinvitationstatus';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('userinvitationstatus', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('userinvitationstatus', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('userinvitationstatus', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('userinvitationstatus', 'view');
