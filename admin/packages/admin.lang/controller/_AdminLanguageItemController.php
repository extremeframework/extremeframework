...
class _AdminLanguageItemController extends __AppController
{
    ...
    public function delete($target_column, $target_values, &$_ids = null) {
        ...
        NotificationHelper::notifyChange('adminlanguageitem', 'delete');
    }
    ...
    protected function save($models = array(), $refobject = null) {
        ...
        foreach ($models as $model) {
    		...
    		if ($model->UUID) {
                ...
                NotificationHelper::notifyChange('adminlanguageitem', 'update');
            } else {
                $model->ID = null;
    		    ...
    		    NotificationHelper::notifyChange('adminlanguageitem', 'insert');
            }
