...
<div id="adminlanguageitem-edit" class="edit_details">
    ...
    <!-- Language bar -->
        ...
        <div class="edit-buttons edit-buttons-top hidden-print">
            ...
            <{if $details->ID}>
                            <{/if}>
            <a class="button-cancel scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/adminlanguageitem/cancel/?return=<{ContextStack::getRecentContext()}>"><{_t('L_CANCEL')}></a>
