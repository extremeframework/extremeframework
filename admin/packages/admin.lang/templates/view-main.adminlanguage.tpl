<div class="view-main">
    <{plugin key="adminlanguage_view_top" args=$details}>
        ...
        <{if !isset($columns2hide) || !in_array('NAME', $columns2hide) }>
    		<td class="form-field form-field-label column-name">
	            		        <label class="attribute-name"><{label key="L_ADMIN_LANGUAGE_NAME"}></label>
            </td>
    ...
    <{plugin key="adminlanguage_view_bottom" args=$details}>

    <script type="text/javascript">
        ///////////////////////////////////////////////////////////////////////////////
        // VISIBILITY REFLECTION
        adminlanguageview_get_visibility_settings = function (model) {
            var settings = {};
        ...
        adminlanguageview_apply_visibility_settings = function (settings) {
            $.each(settings, function(key, value) {
                adminlanguageview_apply_block_visibility(key, value);
            });
        }

        adminlanguageview_apply_block_visibility = function (key, value) {
        ...
        adminlanguageview_update_visibility_settings = function () {
            var settings = adminlanguageview_get_visibility_settings();

            adminlanguageview_apply_visibility_settings(settings);
        }

        $(function() {
            adminlanguageview_update_visibility_settings();
        });
...
//                        type: "post",
//                        dataType: "json",
//                        url: "<{$smarty.const.APPLICATION_URL}>/adminlanguage/fieldSave",
//                        data: td.find(':input').serialize() + "&adminlanguage_formdata_UUID=<{$details->UUID}>"
//                    }).done(function(data) {
//                        if (data.success) {
//                            if (input.is("select")) {
