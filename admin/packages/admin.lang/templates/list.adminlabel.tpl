...
<{assign var='title' value=_t('Admin Label')}>
<{include file="top.tpl"}>

<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="adminlabelquicksearch" class="form-quicksearch scope-list" action="<{$smarty.const.APPLICATION_URL}>/adminlabel/search" method="get">
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/adminlabel/new/"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{_t('New', true)}> <{_t('Admin Label', true)|strtolower}>"/><{_t('New')}> <{_t('Admin Label')|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
        	    ...
        	    <{/if}>
                                            ...
                                            <div class="btn button-general">
                            <a href="#" onclick="adminlabel_delete()"><span class="button-face"><{_t('Delete')}></span></a>
                        </div>
                                            <{/if}>
...
<!-- Relations -->
    <{php}>
    	$template->assign('copyguidelines',  sprintf(_t('L_GUIDELINES_COPY_RELS', true), strtolower(_t('Admin Label', true))));
    	$template->assign('approveguidelines', sprintf(_t('L_GUIDELINES_APPROVE_RELS', true), strtolower(_t('Admin Label', true))));
    	$template->assign('deleteguidelines', sprintf(_t('L_GUIDELINES_DELETE_RELS', true), strtolower(_t('Admin Label', true)), strtolower(_t('Admin Label', true))));
    <{/php}>

    <div id="adminlabelcopyrelations" style="display:none" title="<{_t('Copy', true)}> <{_t('Admin Label', true)|strtolower}>">
        <p><{$copyguidelines}></p>
        <ul>
    ...
    <div id="adminlabelapproverelations" style="display:none" title="<{_t('Approve', true)}> <{_t('Admin Label', true)|strtolower}>">
    ...
    <div id="adminlabeldeleterelations" style="display:none" title="<{_t('Delete', true)}> <{_t('Admin Label', true)|strtolower}>">
