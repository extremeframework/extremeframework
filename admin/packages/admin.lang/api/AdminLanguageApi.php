...
class AdminLanguageApi extends AdminLanguageController
{
    var $module = 'adminlanguage';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('adminlanguage', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('adminlanguage', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('adminlanguage', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('adminlanguage', 'view');
