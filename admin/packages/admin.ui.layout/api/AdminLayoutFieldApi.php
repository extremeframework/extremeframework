...
class AdminLayoutFieldApi extends AdminLayoutFieldController
{
    var $module = 'adminlayoutfield';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('adminlayoutfield', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('adminlayoutfield', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('adminlayoutfield', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('adminlayoutfield', 'view');
