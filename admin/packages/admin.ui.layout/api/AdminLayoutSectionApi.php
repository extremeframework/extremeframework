...
class AdminLayoutSectionApi extends AdminLayoutSectionController
{
    var $module = 'adminlayoutsection';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('adminlayoutsection', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('adminlayoutsection', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('adminlayoutsection', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('adminlayoutsection', 'view');
