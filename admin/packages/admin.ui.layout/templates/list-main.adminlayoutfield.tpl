...
<table class="item_list" id="adminlayoutfieldlist" data-module="adminlayoutfield">
	...
	<tfoot>
            	...
            	<tr class="additem">
            	    <td colspan="2"></td>
            		<td colspan="<{$colcount}>">
                        <span style="cursor:pointer;text-decoration:underline;color:blue" class="adminlayoutfield-rowedit-add"><{_t('Add item')}></span>
                	    <span class="adminlayoutfield-rowedit-buttons" style="display:none">
                    	    <div class="rowedit-save adminlayoutfield-rowedit-save btn btn-success"><{_t('Save')}></div>
                    	    <a class="rowedit-cancel adminlayoutfield-rowedit-cancel button-cancel"><{_t('Cancel')}></a>
                        </span>
