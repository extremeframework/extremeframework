...
<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="adminlayoutsectionquicksearch" class="form-quicksearch scope-main" action="<{$smarty.const.APPLICATION_URL}>/adminlayoutsection/search" method="get">
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
            		        ...
            		        <div class="btn button-general">
            		            <a class="button-new scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/adminlayoutsection/new/<{if isset($preset) && isset($presetvalue)}>preset/<{$preset}>/presetvalue/<{$presetvalue}><{/if}><{if isset($presetstring)}>?<{$presetstring}><{/if}>"><span class="button-face"><img class="button-icon" src="<{$smarty.const.APPLICATION_URL}>/images/button-icon-add.png" alt="<{_t('New', true)}> <{_t('Admin Layout Section', true)|strtolower}>"/><{_t('New')}> <{_t('Admin Layout Section')|strtolower}></span></a>
            		        </div>
                                    		        <{/if}>
...
<!-- List -->
<form name="adminlayoutsectionlist" id="adminlayoutsectionlistform" class="form-list scope-main" action="<{$smarty.const.APPLICATION_URL}>/adminlayoutsection/" method="post">
...
<{if $pagination || $total > 10}>
	...
	<div style="clear:both"></div>
            ...
            <script type="text/javascript">
            $(function() {
            	bind_hotkey('#adminlayoutsectionlistform', 'left', '.pagination-prev');
            	bind_hotkey('#adminlayoutsectionlistform', 'right', '.pagination-next');
            });
        </script>
    <{else}>
	<br>
