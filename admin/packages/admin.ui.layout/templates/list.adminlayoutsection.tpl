...
<{assign var='title' value=_t('L_ADMIN_LAYOUT_SECTION')}>
...
<!-- Relations -->
    <{php}>
    	$template->assign('copyguidelines',  sprintf(_t('L_GUIDELINES_COPY_RELS'), strtolower(_t('L_ADMIN_LAYOUT_SECTION'))));
    	$template->assign('approveguidelines', sprintf(_t('L_GUIDELINES_APPROVE_RELS'), strtolower(_t('L_ADMIN_LAYOUT_SECTION'))));
