...
<{if isset($title) }>
    <h1 class="heading">
        ...
        <span style="margin-left:10px; font-size:12px; font-weight: normal" class="hidden-print">
            <a style="text-decoration: none" class="button-view-refresh scope-main cachable" href="<{$smarty.const.APPLICATION_URL}>/adminlayoutsection"><i class="fa fa-refresh"></i></a>
        </span>
    </h1>
<{/if}>
        ...
        <ul class="subtabs">
            ...
            <div class="buttons">
        	    ...
        	    <{/if}>
                                            ...
                                            <div class="btn button-general">
                            <a href="#" onclick="adminlayoutsection_delete()"><span class="button-face"><{_t('L_DELETE')}></span></a>
                        </div>
                                            <{/if}>
...
<!-- Relations -->
    <{php}>
    	$template->assign('copyguidelines',  sprintf(_t('L_GUIDELINES_COPY_RELS'), strtolower(_t('Admin Layout Section'))));
    	$template->assign('approveguidelines', sprintf(_t('L_GUIDELINES_APPROVE_RELS'), strtolower(_t('Admin Layout Section'))));
    	$template->assign('deleteguidelines', sprintf(_t('L_GUIDELINES_DELETE_RELS'), strtolower(_t('Admin Layout Section')), strtolower(_t('Admin Layout Section'))));
    <{/php}>

    <div id="adminlayoutsectioncopyrelations" style="display:none" title="<{_t('Copy', true)}> <{_t('Admin Layout Section', true)|strtolower}>">
        <p><{$copyguidelines}></p>
        <ul>
    ...
    <div id="adminlayoutsectionapproverelations" style="display:none" title="<{_t('Approve', true)}> <{_t('Admin Layout Section', true)|strtolower}>">
    ...
    <div id="adminlayoutsectiondeleterelations" style="display:none" title="<{_t('Delete', true)}> <{_t('Admin Layout Section', true)|strtolower}>">
