<div class="modal-header">
    ...
    <h3><{label key="L_QUICK_CREATE" format="ucwords"}> <{$smarty.const.L_ADMIN_LAYOUT_SECTION|ucwords}></h3>
</div>
...
<div id="adminlayoutsection-edit" class="edit_details">
    ...
    <{if isset($messages.adminlayoutsection) }>
        <ul class="message">
            <{foreach from=$messages.adminlayoutsection key=field item=message}>
        ...
        <{else}>
    		<td class="form-row form-row-name form-row-mandatory">
                <div class="form-field form-field-label">
        		    <label><{label key="L_ADMIN_LAYOUT_SECTION_NAME"}><span class="mandatory">*</span></label>
                </div>
            </td>
...
<{if !isset($excludedcolumns['SHOW_TITLE'])}>
        ...
        <{else}>
    		<td class="form-row form-row-show-title">
                <div class="form-field form-field-label">
        		    <label><{label key="L_SHOW_TITLE"}></label>
                </div>
            </td>
