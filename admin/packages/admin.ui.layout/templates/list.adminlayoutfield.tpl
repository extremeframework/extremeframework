...
<{assign var='title' value=$smarty.const.L_ADMIN_LAYOUT_FIELD}>
<{include file="top.tpl"}>

<!-- Quick search -->
    <div class="quicksearch hidden-print">
        <form id="adminlayoutfieldquicksearch" class="form-quicksearch scope-list" action="<{$smarty.const.APPLICATION_URL}>/adminlayoutfield/search" method="post" enctype="multipart/form-data">
