...
<table class="item_list" id="adminlayoutsectionlist" data-module="adminlayoutsection">
	...
	<tfoot>
            	...
            	<tr class="additem">
            	    <td colspan="2"></td>
            		<td colspan="<{$colcount}>">
                        <span style="cursor:pointer;text-decoration:underline;color:blue" class="adminlayoutsection-rowedit-add"><{_t('L_ADD_ITEM')}></span>
                	    <span class="adminlayoutsection-rowedit-buttons" style="display:none">
                    	    <div class="rowedit-save adminlayoutsection-rowedit-save btn btn-success"><{_t('L_SAVE')}></div>
                    	    <a class="rowedit-cancel adminlayoutsection-rowedit-cancel button-cancel"><{_t('L_CANCEL')}></a>
                        </span>
