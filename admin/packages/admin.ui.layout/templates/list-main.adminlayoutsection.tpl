...
<table class="item_list" id="adminlayoutsectionlist" data-module="adminlayoutsection">
        ...
        <{assign var='colcount' value=1}>
    	        ...
    	        <{if !isset($excludedcolumns['NAME']) && ((isset($aclviewablecolumns['NAME']) && $aclviewablecolumns['NAME']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['NAME']) || $aclviewablecolumns['NAME']))) }>
    	            <th class="column-name">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/adminlayoutsection/sort/name"><{label key="L_ADMIN_LAYOUT_SECTION_NAME"}></a>
            ...
            <{/if}>
    	        ...
    	        <{if !isset($excludedcolumns['MODULE']) && ((isset($aclviewablecolumns['MODULE']) && $aclviewablecolumns['MODULE']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['MODULE']) || $aclviewablecolumns['MODULE']))) }>
    	            <th class="column-module">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/adminlayoutsection/sort/module"><{label key="L_MODULE"}></a>
            ...
            <{/if}>
    	        ...
    	        <{if !isset($excludedcolumns['SHOW_TITLE']) && ((isset($aclviewablecolumns['SHOW_TITLE']) && $aclviewablecolumns['SHOW_TITLE']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['SHOW_TITLE']) || $aclviewablecolumns['SHOW_TITLE']))) }>
    	            <th class="column-show-title">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/adminlayoutsection/sort/show_title"><{label key="L_SHOW_TITLE"}></a>
            ...
            <{/if}>
    	        ...
    	        <{if !isset($excludedcolumns['ORDERING']) && ((isset($aclviewablecolumns['ORDERING']) && $aclviewablecolumns['ORDERING']) || (isset($aclviewablecolumns['*']) && (!isset($aclviewablecolumns['ORDERING']) || $aclviewablecolumns['ORDERING']))) }>
    	            <th class="column-ordering">
            	                    	            <a class="sorter scope-list" href="<{$smarty.const.APPLICATION_URL}>/adminlayoutsection/sort/ordering"><{label key="L_ORDERING"}></a>
	...
	<tr class="top-holder" style="display:none">
	    <td colspan="<{$colcount+2}>" style="text-align:center;">
	    	<div class="selectall">All <{$rows|@count}> <{$smarty.const.L_ADMIN_LAYOUT_SECTION|strtolower}>s on this page are selected. <a onclick="adminlayoutsection_selectall()">Select all <{$total}> <{$smarty.const.L_ADMIN_LAYOUT_SECTION|strtolower}>s in the list</a></div>
	    	<div class="clearselection">All <{$total}> <{$smarty.const.L_ADMIN_LAYOUT_SECTION|strtolower}>s in the list are selected. <a onclick="adminlayoutsection_clearselection()">Clear selection</a></div>
		</td>
	</tr>
	<{/if}>
	...
	<tfoot>
            	...
            	<tr class="additem">
            	    <td colspan="2"></td>
            		<td colspan="<{$colcount}>">
                        <span style="cursor:pointer;text-decoration:underline;color:blue" class="adminlayoutsection-rowedit-add"><{label key="L_ADD_ITEM"}></span>
                	    <span class="adminlayoutsection-rowedit-buttons" style="display:none">
                    	    <div class="rowedit-save adminlayoutsection-rowedit-save btn btn-success"><{label key="L_SAVE"}></div>
                    	    <a class="rowedit-cancel adminlayoutsection-rowedit-cancel button-cancel"><{label key="L_CANCEL"}></a>
                        </span>
