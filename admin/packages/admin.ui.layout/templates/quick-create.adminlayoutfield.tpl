<div class="modal-header">
    ...
    <h3><{label key="L_QUICK_CREATE" format="ucwords"}> <{$smarty.const.L_ADMIN_LAYOUT_FIELD|ucwords}></h3>
</div>
...
<div id="adminlayoutfield-edit" class="edit_details">
    ...
    <{if isset($messages.adminlayoutfield) }>
        <ul class="message">
            <{foreach from=$messages.adminlayoutfield key=field item=message}>
...
<{if !isset($excludedcolumns['MODULE'])}>
        ...
        <{else}>
            ...
            <{html_ref_select autocomplete="1" ajax="0" method="" id="input-module" class="input-module" name="`$prefix`adminlayoutfield_formdata_MODULE" value=$details->MODULE text=$details->reftext_MODULE datasource="ADMIN_MODULE" valuecol="MODULE" textcol="NAME" sortcol="" groupcol="" blankitem=""}>
...
<{if !isset($excludedcolumns['ID_ADMIN_LAYOUT_SECTION'])}>
        ...
        <{else}>
    		<td class="form-row form-row-id-admin-layout-section">
                <div class="form-field form-field-label">
        		    <label><{label key="L_ADMIN_LAYOUT_SECTION"}></label>
                </div>
            </td>
...
<{if !isset($excludedcolumns['COLUMN'])}>
        ...
        <{else}>
    		<td class="form-row form-row-column form-row-mandatory">
                <div class="form-field form-field-label">
        		    <label><{label key="L_COLUMN"}><span class="mandatory">*</span></label>
                </div>
            </td>
...
<{if !isset($excludedcolumns['POSITION'])}>
        ...
        <{else}>
    		<td class="form-row form-row-position">
                <div class="form-field form-field-label">
        		    <label><{label key="L_POSITION"}></label>
                </div>
            </td>
