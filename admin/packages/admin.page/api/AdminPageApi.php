...
class AdminPageApi extends AdminPageController
{
    var $module = 'adminpage';
    var $type = 'api';

	function searchAction() {
	    AclApi::checkPermission('adminpage', 'list');
    ...
    function saveAction() {
        AclApi::checkPermission('adminpage', 'edit');
    ...
    function deleteAction() {
        AclApi::checkPermission('adminpage', 'delete');
    ...
    function viewAction() {
	    AclApi::checkPermission('adminpage', 'view');
