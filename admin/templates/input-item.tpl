...
<{elseif $columnsettings.$column->type == 'yesno'}>
    <input class="input-<{$columnsettings.$column->code}>" type="radio" name="<{$prefix}><{$module}>_formdata_<{$column}>" value="1" <{if $formdata.<{$column}>}>checked="checked"<{/if}>><{_t('L_YES')}> <input type="radio" name="<{$prefix}><{$module}>_formdata_<{$column}>" value="0" <{if !$formdata.<{$column}>}>checked="checked"<{/if}>><{_t('L_NO')}>
<{elseif $columnsettings.$column->type == 'truefalse'}>
    <input class="input-<{$columnsettings.$column->code}>" type="radio" name="<{$prefix}><{$module}>_formdata_<{$column}>" value="1" <{if $formdata.<{$column}>}>checked="checked"<{/if}>><{_t('L_TRUE')}> <input type="radio" name="<{$prefix}><{$module}>_formdata_<{$column}>" value="0" <{if !$formdata.<{$column}>}>checked="checked"<{/if}>><{_t('L_FALSE')}>
<{elseif $columnsettings.$column->type == 'enabledisable'}>
    <input class="input-<{$columnsettings.$column->code}>" type="radio" name="<{$prefix}><{$module}>_formdata_<{$column}>" value="1" <{if $formdata.<{$column}>}>checked="checked"><{/if}>><{_t('L_ENABLED')}> <input type="radio" name="<{$prefix}><{$module}>_formdata_<{$column}>" value="0" <{if !$formdata.<{$column}>}>checked="checked"<{/if}>><{_t('L_DISABLED')}>
