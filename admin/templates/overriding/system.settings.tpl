...
<h1 class="heading">
    <span class="h">System Settings</span>
</h1>
...
<div class="edit_details">
    ...
    <div class="edit-buttons edit-buttons-top">
        <div class="button-general button-save btn btn-success">
            <a class="button-save" onclick="$('#system-configuration-form').submit();return false;"><span class="button-face"><{label key="L_SAVE"}></span></a>
        </div>
