...
<h1 class="heading">
    <span class="h"><i class="module-icon fa fa-paper-plane-o"></i>System Settings</span>
</h1>
...
<div class="edit_details">
    ...
    <div class="edit-buttons edit-buttons-top">
        <div class="button-general button-save btn btn-success">
            <a class="button-save" onclick="$('#system-configuration-form').submit();return false;"><span class="button-face"><{_t('Save')}></span></a>
        </div>
        <div class="clearer"></div>
    </div>

    <form name="configuration-form" id="system-configuration-form" class="scope-main" action="<{$smarty.const.APPLICATION_URL}>/system/saveSettings" method="post" enctype="multipart/form-data">
